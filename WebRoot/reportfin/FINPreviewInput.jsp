...
<%
	...
	filePath += "/temp/Midplat_FIN_Report_Preview.xls";
	ExcelUtils eu = new ExcelUtils("FIN", filePath,"FINPreview");
	...
	System.out.println("FINPreviewInput.jsp中ManageCodeNo=" + sManageCodeNo);
	...
	if (!tFIN_PrintBL.submitData(tVData, "download")) {
		...
		file = (File) tFIN_PrintBL.getResult().get(1);
