...
function initForm()
{
	...
	{
		alert("IcbcProCheckInit.jsp-->InitForm 函数中发生异常:初始化界面错误!");
	}
}
...
function initInputBox() 
{
	...
	//地区代码 名称
	fm.RegionCodeName.value = '北京分公司';
	//网点代码 名称 
	fm.BranchName.value = '工商银行-新街口德外支行';
	//柜员代码
...
//主险信息
	...
	//主险名称
	fm.RiskCodeName.value = '(PAC)工银安盛人寿盛世年年年金保险（分红型）';
	//份数 
...
// 
	...
	{
		alert("IcbcProCheckInit.jsp-->initInputBox 函数中发生异常:初始化界面错误!");
	}
}
...
//
	...
	{
		alert("IcbcProCheckInit.jsp-->initBox 函数中发生异常:初始化界面错误!");
	}
}
