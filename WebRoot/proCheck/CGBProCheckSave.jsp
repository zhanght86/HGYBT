...
//把保单信息在页面显示
		...
		xmlContent += "  职业告知标志: " + sOccupationIndicator ;
		...
		ElementLis OLifE = new ElementLis("OLifE",TXLifeRequest); 
			ElementLis HoldingH1 = new ElementLis("Holding","id","Holding_1",OLifE);
				ElementLis Policy = new ElementLis("Policy",HoldingH1);       
					...
					ElementLis PaymentAmt = new ElementLis("PaymentAmt",sPaymentAmt,Policy);
					ElementLis Life = new ElementLis("Life",Policy); 
						ElementLis Coverage = new ElementLis("Coverage","id","Cov_1",Life);
							...
							ElementLis BenefitMode = new ElementLis("BenefitMode","","tc","",Coverage);
...
//如果有附加险1    
						if(!(sProductCode2==null||sProductCode2.equals(""))){
								ElementLis Coverage2 = new ElementLis("Coverage","id","Cov_3",Life);
									...
									ElementLis BenefitMode2 = new ElementLis("BenefitMode","","tc","",Coverage2);
						...
						ElementLis Coverage1 = new ElementLis("Coverage","id","Cov_2",Life);
							...
							ElementLis BenefitMode1 = new ElementLis("BenefitMode","","tc","",Coverage1);
...
//账户信息		
						...
						if(!(sAccCode1==null||sAccCode1.equals("")) || !(sAccCode2==null||sAccCode2.equals("")) || !(sAccCode3==null||sAccCode3.equals(""))){
					...
					ElementLis OLifEExtension2 = new ElementLis("OLifEExtension","VendorCode","2",Policy);
						...
						ElementLis SpecialClause = new ElementLis("SpecialClause","",OLifEExtension2);
			...
			ElementLis Relation_4 = new ElementLis("Party_1","Party_2","Relation_4","6","6",sAppToInsRelation,OLifE);	
...
//如果有第三受益人 									 
		...
		ElementLis OLifEExtension3 = new ElementLis("OLifEExtension","VendorCode","3",TXLifeRequest); 
...
//System.out.println("************************3************************");
		...
		CGBProCheckUI mTestUI = new CGBProCheckUI(sIp,iPort);  
