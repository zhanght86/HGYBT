...
//	String mInsPolcy_Pswd = request.getParameter("mInsPolcy_Pswd");
	String mLv1_Br_No = request.getParameter("Lv1_Br_No");
	String mPlchd_Crdt_TpCd = request.getParameter("mPlchd_Crdt_TpCd");
	String mPlchd_Crdt_No = request.getParameter("mPlchd_Crdt_No");
	
	String mInsPrem_Amt = request.getParameter("InsPrem_Amt");
	String mHdCg_FeeRt = request.getParameter("HdCg_FeeRt");
	String mCmpn_CstMgr_ID = request.getParameter("Cmpn_CstMgr_ID");
 ...
 System.out.println("************************装载XML************************");		 
	...
	//协议报文头
 	...
 	ElementLis APP_ENTITY = new ElementLis("APP_ENTITY",ENTITY);	
 		...
 		ElementLis  cmInsPrem_Amt= new ElementLis("InsPrem_Amt",mInsPrem_Amt,APP_ENTITY);
 		ElementLis  cmHdCg_FeeRt= new ElementLis("HdCg_FeeRt",mHdCg_FeeRt,APP_ENTITY);
 		ElementLis  cmCmpn_CstMgr_ID= new ElementLis("Cmpn_CstMgr_ID",mCmpn_CstMgr_ID,APP_ENTITY);
 
 		ElementLis  cmLv1_Br_No= new ElementLis("Lv1_Br_No",mLv1_Br_No,APP_ENTITY);
 		//ElementLis  cmTel_OutbndCall_Ind= new ElementLis("Tel_OutbndCall_Ind",mTel_OutbndCall_Ind,APP_ENTITY);
