...
<script type="text/javascript">
		...
		<%@include file="RequestCancelInit.jsp"%>  

		<title>银保通测试</title>
	</head>
<body onload="initElementtype();initForm();">
<form action="./RequestCancelSave.jsp" method=post name=fm target="fraSubmit">
...
<table class=common align=center>
	...
	<TR>
		...
		<TD class=input><select name="TRANSCODE" style="background-color: #D7E1F6">
			    <option value="P53819143">申请退保</option>
			</select></TD>
...
<table class=common align=center>
	...
	<TR class=common>
		...
		<TD class=title>#电话外呼标志</TD>
		<TD class=input><Input class=input name="mTel_OutbndCall_Ind"/></TD>
	</TR>
	<TR class=common>
