...
<%
 ...
 //头节点
	...
	String mIns_Co_ID = request.getParameter("mIns_Co_ID");
	String mInsPolcy_No = request.getParameter("mInsPolcy_No");
	String m__BEGIN_REC = request.getParameter("m__BEGIN_REC");
	
	String m__MAX_REC = request.getParameter("m__MAX_REC");
	String mQRY_START_DT = request.getParameter("mQRY_START_DT");
	String mQRY_END_DT = request.getParameter("mQRY_END_DT");
	
	String mCCB_AccNo = request.getParameter("mCCB_AccNo");
	String mIns_Mnplt_Psn_ID = request.getParameter("mIns_Mnplt_Psn_ID");
 ...
 System.out.println("************************装载XML************************");		 
	...
	//协议报文头
 	...
 	ElementLis COM_ENTITY = new ElementLis("COM_ENTITY",ENTITY);
 		...
 		//保险公司编号
 		ElementLis Ins_Co_ID = new ElementLis("Ins_Co_ID","03",COM_ENTITY);
 		//#服务方流水号
 	...
 	ElementLis APP_ENTITY = new ElementLis("APP_ENTITY",ENTITY);	
 		...
 		ElementLis  cmIns_Co_ID= new ElementLis("Ins_Co_ID",mIns_Co_ID,APP_ENTITY);
 		ElementLis  cmInsPolcy_No= new ElementLis("InsPolcy_No",mInsPolcy_No,APP_ENTITY);
  //		ElementLis  cm__BEGIN_REC= new ElementLis("__BEGIN_REC",m__BEGIN_REC,APP_ENTITY);
 //		ElementLis  cm__MAX_REC= new ElementLis("__MAX_REC",m__MAX_REC,APP_ENTITY);
 		ElementLis  cmCCB_AccNo= new ElementLis("CCB_AccNo",mCCB_AccNo,APP_ENTITY);
 		ElementLis  cmIns_Mnplt_Psn_ID= new ElementLis("Ins_Mnplt_Psn_ID",new DateUtil().date10to8(mIns_Mnplt_Psn_ID),APP_ENTITY);
 		ElementLis  cmQRY_START_DT= new ElementLis("QRY_START_DT",new DateUtil().date10to8(mQRY_START_DT),APP_ENTITY);
 		ElementLis  cmQRY_END_DT= new ElementLis("QRY_END_DT",mQRY_END_DT,APP_ENTITY);
