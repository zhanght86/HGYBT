...
<SCRIPT src="QueryPolicyDetail.js"></SCRIPT>
<script type="text/javascript">
		...
		<%@include file="QueryPolicyDetailInit.jsp"%>  

		<title>银保通测试</title>
	</head>
<body onload="initElementtype();initForm();">
<form action="./QueryPolicyDetailSave.jsp" method=post name=fm target="fraSubmit">
...
<table class=common align=center>
	...
	<TR>
		...
		<TD class=input><select name="TRANSCODE" style="background-color: #D7E1F6">
			    <option value="P53816107">获取保单详情取数（寿险）</option>
			</select></TD>
