...
<SCRIPT src=ActInsuSaleRemindAccess.js></SCRIPT>
<script type="text/javascript">
		...
		<%@include file="ActInsuSaleRemindAccessInit.jsp"%>  

		<title>银保通测试</title>
	</head>
<body onload="initElementtype();initForm();">
<form action="./ActInsuSaleRemindAccessSave.jsp" method=post name=fm target="fraSubmit">
...
<table class=common align=center>
	...
	<TR>
		...
		<TD class=input><select name="TRANSCODE" style="background-color: #D7E1F6">
			    <option value="P5381B223">代理保险售后提醒取数</option>
			</select></TD>
...
<table class=common align=center>
	...
	<TR class=common>
		<TD class=title>代理保险批量包名称</TD>
		<TD class=input><Input class=input name="AgIns_BtchBag_Nm"/>必填</TD>
	</TR>
</table>
