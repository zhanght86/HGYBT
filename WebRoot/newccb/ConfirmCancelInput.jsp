...
<script type="text/javascript">
		...
		<%@include file="ConfirmCancelInit.jsp"%>  

		<title>银保通测试</title>
	</head>
<body onload="initElementtype();initForm();">
<form action="./ConfirmCancelSave.jsp" method=post name=fm target="fraSubmit">
...
<table class=common align=center>
	...
	<TR>
		...
		<TD class=input><select name="TRANSCODE" style="background-color: #D7E1F6">
			    <option value="P53819144">确认退保</option>
			</select></TD>
...
<table class=common align=center>
	...
	<TR class=common>
		...
		<TD class=title>#退保实时退费标志</TD>
		<TD class=input><Input class=input name="mCIRlTmRtF_Ind"/></TD>
	</TR>
	<TR class=common>
