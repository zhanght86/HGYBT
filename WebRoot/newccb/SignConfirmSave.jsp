...
<%
 ...
 //头节点
	...
	String mIns_Co_Jrnl_No = request.getParameter("Ins_Co_Jrnl_No");
	String mChnl_TpCd = request.getParameter("Chnl_TpCd");
	String mCCBIns_Nm = request.getParameter("CCBIns_Nm");
//	String mCCBIns_ID = request.getParameter("CCBIns_ID");
	String mCtc_Tel = request.getParameter("Ctc_Tel");
//	String mPlchd_Crdt_No = request.getParameter("mPlchd_Crdt_No");
	
	String mFst_Benf_Nm = request.getParameter("Fst_Benf_Nm");
	String mHdCg = request.getParameter("HdCg");
	String mCstMgr_Blng_CCBIns_ID = request.getParameter("CstMgr_Blng_CCBIns_ID");
 ...
 System.out.println("************************装载XML************************");		 
	...
	//协议报文头
 	...
 	ElementLis COM_ENTITY = new ElementLis("COM_ENTITY",ENTITY);
 		...
 		//保险公司编号
 		ElementLis Ins_Co_ID = new ElementLis("Ins_Co_ID","CCB",COM_ENTITY);
 		//#服务方流水号
 	...
 	ElementLis APP_ENTITY = new ElementLis("APP_ENTITY",ENTITY);	
 		...
 		ElementLis  cmChnl_TpCd= new ElementLis("Chnl_TpCd",mChnl_TpCd,APP_ENTITY);
 		ElementLis  cmCCBIns_Nm= new ElementLis("CCBIns_Nm",mCCBIns_Nm,APP_ENTITY);
 		ElementLis  cmCCBIns_ID= new ElementLis("CCBIns_ID",mCCBIns_ID,APP_ENTITY);
 		ElementLis  cmCtc_Tel= new ElementLis("Ctc_Tel",mCtc_Tel,APP_ENTITY);
 		ElementLis  cmFst_Benf_Nm= new ElementLis("Fst_Benf_Nm",mFst_Benf_Nm,APP_ENTITY);
 
 		ElementLis  cmHdCg= new ElementLis("HdCg",mHdCg,APP_ENTITY);
 		ElementLis  cmCstMgr_Blng_CCBIns_ID= new ElementLis("CstMgr_Blng_CCBIns_ID",mCstMgr_Blng_CCBIns_ID,APP_ENTITY);
