...
<SCRIPT src="QueryPolicyNum.js"></SCRIPT>
<script type="text/javascript">
		...
		<%@include file="QueryPolicyNumInit.jsp"%>  

		<title>银保通测试</title>
	</head>
<body onload="initElementtype();initForm();">
<form action="./QueryPolicyNumSave.jsp" method=post name=fm target="fraSubmit">
...
<table class=common align=center>
	...
	<TR>
		...
		<TD class=input><select name="TRANSCODE" style="background-color: #D7E1F6">
			    <option value="P53817107">获取保单详情查询</option>
			</select></TD>
