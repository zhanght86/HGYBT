...
function initForm()
{
	...
	{
		alert("CancelRenewalFeeInit.jsp-->InitForm11 函数中发生异常:初始化界面错误!");
	}
}
...
function initInputBox() 
{
	...
	fm.port.value = '39871';  
	fm.TRANSCODE.value = 'P53819154'; 

	}
	catch(re)
	{
		alert("CancelRenewalFeeInit.jsp-->initInputBox22 函数中发生异常:初始化界面错误!");
	}
}
...
function initBox(){
	...
	fm.TRANSCODE.value = 'P53819154'; 
		...
		alert("CancelRenewalFeeInit.jsp-->initBox()函数中发生异常：初始化错误！");
	}
