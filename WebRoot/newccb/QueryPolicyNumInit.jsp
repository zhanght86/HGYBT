...
function initForm()
{
	...
	{
		alert("QueryPolicyNumInit.jsp-->InitForm11 函数中发生异常:初始化界面错误!");
	}
}
...
function initInputBox() 
{
	...
	fm.port.value = '39871'; 
	fm.TRANSCODE.value = 'P53817107'; 

	}
	catch(re)
	{
		alert("QueryPolicyNumInit.jsp-->initInputBox22 函数中发生异常:初始化界面错误!");
	}
}
...
function initBox(){
	...
	fm.TRANSCODE.value = 'P53817107'; 
		...
		alert("QueryPolicyNumInit.jsp-->initBox()函数中发生异常：初始化错误！");
	}
