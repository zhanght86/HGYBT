...
function TranFlag(c){
	...
	var sTranNo1 =null;
	var sTranFlagCode = fm.all('tranFlagCode').value;
	if(sTranFlagCode == 'P53819113'){
		sTranNo1 = fm.all('TransRefGUID').value;
		NewContInput();
	}
	if(sTranFlagCode == 'P53819188'){
	}
	if(sTranFlagCode == 'P53819151'){
	}
	if(sTranFlagCode == 'P53819152'){
		NewContConfirm();
	}
	if(sTranFlagCode == 'P53819182'){
...
function confirmTransaction()
{
	...
	fm.action = "./TestYBTNewCCBConfirmSave.jsp";
...
function cancleTransaction()
{
	...
	fm.action = "./TestYBTNewCCBCancleSave.jsp";
...
function reprintCont()
{
	...
	fm.action = "./TestYBTNewCCBRePrtSave.jsp";
	fm.submit();
...
function queryPrtNo()
{
	...
	function setFlag(){
		var AppToInsRelation=fm.all('AppToInsRelation').value;
		if (AppToInsRelation=="1"){
			fm.InsFlag.checked=true;
			document.getElementById("Ins0").readOnly=true;  
...
//			document.getElementById("Ins13").disabled=true;
			//document.getElementById("Ins14").disabled=true;
			//document.getElementById("Ins15").disabled=true;
			document.getElementById("InsCountry").readOnly=true;
...
//被保人信息 
	...
	//被保人姓名拼音全称
	fm.Rcgn_CPA_FullNm.value = fm.Rcgn_CPA_FullNm.value;
	//被保人性别
	...
	fm.InsInCome.value = fm.PbInCome.value;
	//健康告知
...
//被保人信息 
	...
	fm.Rcgn_Prov_Cd.value=fm.Plchd_Prov_Cd.value;
	fm.Rcgn_City_Cd.value=fm.Plchd_City_Cd.value;
	fm.Rcgn_CntyAndDstc_Cd.value=fm.Plchd_CntyAndDstc_Cd.value;
	fm.Rcgn_Dtl_Adr_Cntnt.value=fm.Plchd_Dtl_Adr_Cntnt.value;
	...
	fm.all('AppToInsRelation').value='1'; 
		...
		{    
			document.getElementById("Ins0").readOnly=false;
			...
			//document.getElementById("Ins14").disabled=false;
			//document.getElementById("Ins15").disabled=false;
...
//被保人信息
	...
	//被保人姓名
	fm.Rcgn_CPA_FullNm.value = 'Bei Baoren1';
	//被保人性别
