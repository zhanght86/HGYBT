...
<%
 ...
 //头节点
	...
	String mCrdt_TpCd = request.getParameter("mCrdt_TpCd");
	String mIns_Co_Acrdt_Stff_Nm = request.getParameter("mIns_Co_Acrdt_Stff_Nm");
	String mCrdt_No = request.getParameter("mCrdt_No");
 ...
 System.out.println("************************装载XML************************");		 
	...
	//协议报文头
 	...
 	ElementLis APP_ENTITY = new ElementLis("APP_ENTITY",ENTITY);	
 		//
 		ElementLis  cmCrdt_TpCd= new ElementLis("Crdt_TpCd",mCrdt_TpCd,APP_ENTITY);
 		ElementLis  cmIns_Co_Acrdt_Stff_Nm= new ElementLis("Ins_Co_Acrdt_Stff_Nm",mIns_Co_Acrdt_Stff_Nm,APP_ENTITY);
 		ElementLis  cmCrdt_No= new ElementLis("Crdt_No",mCrdt_No,APP_ENTITY);
