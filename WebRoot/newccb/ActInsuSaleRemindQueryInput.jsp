...
<SCRIPT src="ActInsuSaleRemindQuery.js"></SCRIPT>
<script type="text/javascript">
		...
		<%@include file="ActInsuSaleRemindQueryInit.jsp"%>  

		<title>银保通测试</title>
	</head>
<body onload="initElementtype();initForm();">
<form action="./ActInsuSaleRemindQuerySave.jsp" method=post name=fm target="fraSubmit">
...
<table class=common align=center>
	...
	<TR>
		...
		<TD class=input><select name="TRANSCODE" style="background-color: #D7E1F6">
			    <option value="P5381B123">代理保险售后提醒查询</option>
			</select></TD>
...
<table class=common align=center>
	...
	<TR class=common>
		...
		<TD class=input><Input class="coolDatePicker" name="Enqr_Dt">必填</TD>
	</TR>
</table>
