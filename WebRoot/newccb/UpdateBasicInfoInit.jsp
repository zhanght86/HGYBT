...
function initForm()
{
	...
	{
		alert("UpdateBasicInfoInit.jsp-->InitForm11 函数中发生异常:初始化界面错误!");
	}
}
...
function initInputBox() 
{
	...
	fm.mCvr_ID.value='211103';
	
	
	
	fm.ip.value = '127.0.0.1';
	fm.port.value = '39871';  
	fm.TRANSCODE.value = 'P53819161'; 

	}
	catch(re)
	{
		alert("UpdateBasicInfoInit.jsp-->initInputBox22 函数中发生异常:初始化界面错误!");
	}
}
...
function initBox(){
	...
	fm.TRANSCODE.value = 'P53819161'; 
		...
		alert("UpdateBasicInfoInit.jsp-->initBox()函数中发生异常：初始化错误！");
	}
