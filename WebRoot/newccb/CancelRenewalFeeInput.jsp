...
<table class=common align=center>
	...
	<TR>
		...
		<TD class=input><select name="TRANSCODE" style="background-color: #D7E1F6">
			    <option value="P53819154">确认取消续期缴费</option>
			</select></TD>
...
<table class=common align=center>
	...
	<TR class=common>
		...
		<TD class=input><Input class=input name="mInsPolcy_No"/>必填</TD>
		<TD class=title>保险公司流水号</TD>
		<TD class=input><Input class=input name="mIns_Co_Jrnl_No"/>必填</TD>
	</TR>
	<TR class=common>
		<TD class=title>保单密码</TD>
		<TD class=input><Input class=input name="mLiInsuSlipPWD"/></TD>
		<TD class=title>交易金额</TD>
		<TD class=input><Input class=input name="mTxnAmt"/>必填</TD>
	</TR>
</table>
