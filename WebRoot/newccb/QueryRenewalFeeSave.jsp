...
<%
 ...
 //头节点
	...
	String mIns_BillNo = request.getParameter("mIns_BillNo");
	...
	String mPlchd_Crdt_EfDt = request.getParameter("mPlchd_Crdt_EfDt");
	String mPlchd_Crdt_ExpDt = request.getParameter("mPlchd_Crdt_ExpDt");
	String mPlchd_Nat_Cd = request.getParameter("mPlchd_Nat_Cd");
 ...
 System.out.println("************************装载XML************************");		 
	...
	//协议报文头
 	...
 	ElementLis APP_ENTITY = new ElementLis("APP_ENTITY",ENTITY);	
 		//
 		ElementLis  cmIns_BillNo= new ElementLis("Ins_BillNo",mIns_BillNo,APP_ENTITY);
 		...
 		ElementLis  cmPlchd_Crdt_EfDt= new ElementLis("Plchd_Crdt_EfDt",mPlchd_Crdt_EfDt,APP_ENTITY);
 		ElementLis  cmPlchd_Crdt_ExpDt= new ElementLis("Plchd_Crdt_ExpDt",mPlchd_Crdt_ExpDt,APP_ENTITY);
