...
function initForm()
{
	...
	{
		alert("QueryPolicyDetailInit.jsp-->InitForm11 函数中发生异常:初始化界面错误!");
	}
}
...
function initInputBox() 
{
	...
	fm.AgIns_BtchBag_Nm.value = 'P5381B223_20150813_010072_00001'
	
	fm.ip.value = '127.0.0.1';
	fm.port.value = '39871'; 
	fm.TRANSCODE.value = 'P5381B223'; 

	}
	catch(re)
	{
		alert("QueryPolicyDetailInit.jsp-->initInputBox22 函数中发生异常:初始化界面错误!");
	}
}
...
function initBox(){
	...
	fm.TRANSCODE.value = 'P5381B223'; 
		...
		alert("QueryPolicyDetailInit.jsp-->initBox()函数中发生异常：初始化错误！");
	}
