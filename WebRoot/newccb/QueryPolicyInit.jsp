...
function initForm()
{
	...
	{
		alert("QueryPolicyInit.jsp-->InitForm11 函数中发生异常:初始化界面错误!");
	}
}
...
function initInputBox() 
{
	...
	fm.port.value = '39871'; 
	fm.TRANSCODE.value = 'P53819171'; 

	}
	catch(re)
	{
		alert("QueryPolicyInit.jsp-->initInputBox22 函数中发生异常:初始化界面错误!");
	}
}
...
function initBox(){
	...
	fm.TRANSCODE.value = 'P53819171'; 
		...
		alert("QueryPolicyInit.jsp-->initBox()函数中发生异常：初始化错误！");
	}
