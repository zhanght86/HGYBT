...
<%
 ...
 //头节点
	...
	String mInsPolcy_Pswd = request.getParameter("mInsPolcy_Pswd");
	String mCvr_ID = request.getParameter("mCvr_ID");
	String mPlchd_Nm = request.getParameter("mPlchd_Nm");
	String mPlchd_Crdt_TpCd = request.getParameter("mPlchd_Crdt_TpCd");
	String mPlchd_Crdt_No = request.getParameter("mPlchd_Crdt_No");
	
	String mCrdt_EfDt = request.getParameter("mCrdt_EfDt");
	String mCrdt_ExpDt = request.getParameter("mCrdt_ExpDt");
	String mNat_Cd = request.getParameter("mNat_Cd");
	String mRcgn_Fix_TelNo = request.getParameter("mRcgn_Fix_TelNo");
	String mRcgn_Move_TelNo = request.getParameter("mRcgn_Move_TelNo");
	String mRcgn_ZipECD = request.getParameter("mRcgn_ZipECD");
	
	String mRcgn_Comm_Adr = request.getParameter("mRcgn_Comm_Adr");
	String mRcgn_Email_Adr = request.getParameter("mRcgn_Email_Adr");
	String mPlchd_Comm_Adr = request.getParameter("mPlchd_Comm_Adr");
	String mPlchd_ZipECD = request.getParameter("mPlchd_ZipECD");
	String mPlchd_Fix_TelNo = request.getParameter("mPlchd_Fix_TelNo");
	String mPlchd_Move_TelNo = request.getParameter("mPlchd_Move_TelNo");
	
	String mBtch_Bl_Prt_No = request.getParameter("mBtch_Bl_Prt_No");
	String mPlchd_PyF_AccNo = request.getParameter("mPlchd_PyF_AccNo");
	String mPlchd_Drw_AccNo = request.getParameter("mPlchd_Drw_AccNo");
	String mRcgn_AccNo = request.getParameter("mRcgn_AccNo");
	String mPlchd_Dtl_Adr_Cntnt = request.getParameter("mPlchd_Dtl_Adr_Cntnt");
	String mPlchdFixTelDmstDstcNo = request.getParameter("mPlchdFixTelDmstDstcNo");
	String mPlchdMoveTelItlDstcNo = request.getParameter("mPlchdMoveTelItlDstcNo");
 ...
 System.out.println("************************装载XML************************");		 
	...
	//协议报文头
 	...
 	ElementLis APP_ENTITY = new ElementLis("APP_ENTITY",ENTITY);	
 		...
 		ElementLis  cmInsPolcy_Pswd= new ElementLis("InsPolcy_Pswd",mInsPolcy_Pswd,APP_ENTITY);
 		ElementLis  cmCvr_ID= new ElementLis("Cvr_ID",mCvr_ID,APP_ENTITY);
 		ElementLis  cmPlchd_Nm= new ElementLis("Plchd_Nm",mPlchd_Nm,APP_ENTITY);
 		ElementLis  cmPlchd_Crdt_TpCd= new ElementLis("Plchd_Crdt_TpCd",mPlchd_Crdt_TpCd,APP_ENTITY);
 		ElementLis  cmPlchd_Crdt_No= new ElementLis("Plchd_Crdt_No",mPlchd_Crdt_No,APP_ENTITY);
 		
 		ElementLis  cmCrdt_EfDt= new ElementLis("Crdt_EfDt",mCrdt_EfDt,APP_ENTITY);
 		ElementLis  cmCrdt_ExpDt= new ElementLis("Crdt_ExpDt",mCrdt_ExpDt,APP_ENTITY);
 		ElementLis  cmNat_Cd= new ElementLis("Nat_Cd",mNat_Cd,APP_ENTITY);
 		ElementLis  cmRcgn_Fix_TelNo= new ElementLis("Rcgn_Fix_TelNo",mRcgn_Fix_TelNo,APP_ENTITY);
 		ElementLis  cmRcgn_Move_TelNo= new ElementLis("Rcgn_Move_TelNo",mRcgn_Move_TelNo,APP_ENTITY);
 		ElementLis  cmRcgn_ZipECD= new ElementLis("Rcgn_ZipECD",mRcgn_ZipECD,APP_ENTITY);
 		
 		ElementLis  cmRcgn_Comm_Adr= new ElementLis("Rcgn_Comm_Adr",mRcgn_Comm_Adr,APP_ENTITY);
 		ElementLis  cmRcgn_Email_Adr= new ElementLis("Rcgn_Email_Adr",mRcgn_Email_Adr,APP_ENTITY);
 		ElementLis  cmPlchd_Comm_Adr= new ElementLis("Plchd_Comm_Adr",mPlchd_Comm_Adr,APP_ENTITY);
 		ElementLis  cmPlchd_ZipECD= new ElementLis("Plchd_ZipECD",mPlchd_ZipECD,APP_ENTITY);
 		ElementLis  cmPlchd_Fix_TelNo= new ElementLis("Plchd_Fix_TelNo",mPlchd_Fix_TelNo,APP_ENTITY);
 		ElementLis  cmPlchd_Move_TelNo= new ElementLis("Plchd_Move_TelNo",mPlchd_Move_TelNo,APP_ENTITY);
 		
 		ElementLis  cmBtch_Bl_Prt_No= new ElementLis("Btch_Bl_Prt_No",mBtch_Bl_Prt_No,APP_ENTITY);
 		ElementLis  cmPlchd_PyF_AccNo= new ElementLis("Plchd_PyF_AccNo",mPlchd_PyF_AccNo,APP_ENTITY);
 		ElementLis  cmPlchd_Drw_AccNo= new ElementLis("Plchd_Drw_AccNo",mPlchd_Drw_AccNo,APP_ENTITY);
 		ElementLis  cmRcgn_AccNo= new ElementLis("Rcgn_AccNo",mRcgn_AccNo,APP_ENTITY);
 		ElementLis  cmPlchd_Dtl_Adr_Cntnt= new ElementLis("Plchd_Dtl_Adr_Cntnt",mPlchd_Dtl_Adr_Cntnt,APP_ENTITY);
 		ElementLis  cmPlchdFixTelDmstDstcNo= new ElementLis("PlchdFixTelDmstDstcNo",mPlchdFixTelDmstDstcNo,APP_ENTITY);
 		ElementLis  cmPlchdMoveTelItlDstcNo= new ElementLis("PlchdMoveTelItlDstcNo",mPlchdMoveTelItlDstcNo,APP_ENTITY);
