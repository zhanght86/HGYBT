...
<script type="text/javascript">
		...
		<%@include file="SignPolicyFormatInit.jsp"%>  

		<title>银保通测试</title>
	</head>
<body onload="initElementtype();initForm();">
<form action="./SignPolicyFormatSave.jsp" method=post name=fm target="fraSubmit">
...
<table class=common align=center>
	...
	<TR>
		...
		<TD class=input><select name="TRANSCODE" style="background-color: #D7E1F6">
			    <option value="P538191B2">申请登记台账</option>
			</select></TD>
...
<table class=common align=center>
	...
	<TR class=common>	
		...
		<TD class=title>保费金额</TD>
		<TD class=input><Input class=input name="InsPrem_Amt"/></TD>
	</TR>
	<TR class=common>
	...
	<TR class=common>	
		<TD class=title>手续费费率</TD>
		<TD class=input><Input class=input name="HdCg_FeeRt"/></TD>
		<TD class=title>营销客户经理编号</TD>
		<TD class=input><Input class=input name="Cmpn_CstMgr_ID"/></TD>
	</TR>
	
		<TR class=common>	
		<TD class=title>一级分行号</TD>
		<TD class=input><Input class=input name="Lv1_Br_No"/></TD>
	</TR>
</table>
