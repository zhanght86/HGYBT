...
<script type="text/javascript">
		...
		<%@include file="ConfirmRenewalFeeInit.jsp"%>  

		<title>银保通测试</title>
	</head>
<body onload="initElementtype();initForm();">
<form action="./ConfirmRenewalFeeSave.jsp" method=post name=fm target="fraSubmit">
...
<table class=common align=center>
	...
	<TR>
		...
		<TD class=input><select name="TRANSCODE" style="background-color: #D7E1F6">
			    <option value="P53819156">确认缴费</option>
			</select></TD>
...
<table class=common align=center>
	...
	<TR class=common>
		<TD class=title>保险缴费金额</TD>
		<TD class=input><Input class=input name="mIns_PyF_Amt"/></TD>
		<TD class=title>建行账号</TD>
		<TD class=input><Input class=input name="mCCB_AccNo"/></TD>
	</TR>
	<TR class=common>
		<TD class=title>保费支付方式代码</TD>
		<TD class=input>
			<select name="mInsPrem_PyMd_Cd" style="background-color: #D7E1F6">
				<option value="0">柜台缴纳现金</option>
				<option value="1">折代扣</option>
				<option value="2">借记卡代扣</option>
				<option value="4">对公账户代扣</option>
				<option value="5">结算卡代扣</option>
			</select>
		</TD>
		<TD class=title>保险公司流水号</TD>
