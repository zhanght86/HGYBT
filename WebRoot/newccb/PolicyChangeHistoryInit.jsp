...
function initForm()
{
	...
	{
		alert("PolicyChangeHistoryInit.jsp-->InitForm11 函数中发生异常:初始化界面错误!");
	}
}
...
function initInputBox() 
{
	...
	fm.mCCBIns_ID.value='110000000';
	fm.mCvr_ID.value='231201';
	...
	fm.port.value = '39871'; 
	fm.TRANSCODE.value = 'P53819177'; 

	}
	catch(re)
	{
		alert("PolicyChangeHistoryInit.jsp-->initInputBox22 函数中发生异常:初始化界面错误!");
	}
}
...
function initBox(){
	...
	fm.TRANSCODE.value = 'P53819177'; 
		...
		alert("PolicyChangeHistoryInit.jsp-->initBox()函数中发生异常：初始化错误！");
	}
