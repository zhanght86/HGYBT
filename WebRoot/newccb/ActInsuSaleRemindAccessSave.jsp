...
<%
 ...
 //头节点
	...
	String AgIns_BtchBag_Nm = request.getParameter("AgIns_BtchBag_Nm");
	...
	//协议报文头
 	ElementLis mHeader = new ElementLis("TX_HEADER",TX);	
	 	...
	 	ElementLis SYS_PKG_STS_TYPE = new ElementLis("SYS_PKG_STS_TYPE","00",mHeader);
	 	 ...
	 	 System.out.println("-----------LocalID = 510050  remoteID = 105005----------");
	 	//<LocalID>510050</LocalID>
    	 //<remoteID>105005</remoteID>
	 	ElementLis LocalID = new ElementLis("LocalID","510050",mHeader);
	 	ElementLis remoteID = new ElementLis("remoteID","105005",mHeader);
 	...
 	ElementLis APP_ENTITY = new ElementLis("APP_ENTITY",ENTITY);	
 		new ElementLis("AgIns_BtchBag_Nm",AgIns_BtchBag_Nm,APP_ENTITY);
