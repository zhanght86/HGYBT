...
<%
 ...
 //头节点
	...
	String mAgInSr_BtWthldBag_Num = request.getParameter("mAgInSr_BtWthldBag_Num");
	String mAlrdy_Pcsg_ADdBhBgNum = request.getParameter("mAlrdy_Pcsg_ADdBhBgNum");
	String mAgInSr_BtSbPyBag_Num = request.getParameter("mAgInSr_BtSbPyBag_Num");
	String mAlrdy_Pcsg_SPyBhBgNum = request.getParameter("mAlrdy_Pcsg_SPyBhBgNum");
 ...
 System.out.println("************************装载XML************************");		 
	...
	//协议报文头
 	...
 	ElementLis APP_ENTITY = new ElementLis("APP_ENTITY",ENTITY);	
 		//
 		ElementLis  cmAgInSr_BtWthldBag_Num= new ElementLis("AgInSr_BtWthldBag_Num",mAgInSr_BtWthldBag_Num,APP_ENTITY);
 		ElementLis  cmAlrdy_Pcsg_ADdBhBgNum= new ElementLis("Alrdy_Pcsg_ADdBhBgNum",mAlrdy_Pcsg_ADdBhBgNum,APP_ENTITY);
 		ElementLis  cmAgInSr_BtSbPyBag_Num= new ElementLis("AgInSr_BtSbPyBag_Num",mAgInSr_BtSbPyBag_Num,APP_ENTITY);
 		ElementLis  cmAlrdy_Pcsg_SPyBhBgNum= new ElementLis("Alrdy_Pcsg_SPyBhBgNum",mAlrdy_Pcsg_SPyBhBgNum,APP_ENTITY);
