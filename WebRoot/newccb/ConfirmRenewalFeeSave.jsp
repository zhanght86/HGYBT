...
<%
 ...
 //头节点
	...
	String mIns_PyF_Amt = request.getParameter("mIns_PyF_Amt");
	String mCCB_AccNo = request.getParameter("mCCB_AccNo");
	String mInsPrem_PyMd_Cd = request.getParameter("mInsPrem_PyMd_Cd");
 ...
 System.out.println("************************装载XML************************");		 
	...
	//协议报文头
 	...
 	ElementLis APP_ENTITY = new ElementLis("APP_ENTITY",ENTITY);	
 		//
 		ElementLis  cmIns_PyF_Amt= new ElementLis("Ins_PyF_Amt",mIns_PyF_Amt,APP_ENTITY);
 		ElementLis  cmCCB_AccNo= new ElementLis("CCB_AccNo",mCCB_AccNo,APP_ENTITY);
 		ElementLis  cmInsPrem_PyMd_Cd= new ElementLis("InsPrem_PyMd_Cd",mInsPrem_PyMd_Cd,APP_ENTITY);
