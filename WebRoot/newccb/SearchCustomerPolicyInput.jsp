...
<script type="text/javascript">
		...
		<%@include file="SearchCustomerPolicyInit.jsp"%>  

		<title>银保通测试</title>
	</head>
<body onload="initElementtype();initForm();">
<form action="./SearchCustomerPolicySave.jsp" method=post name=fm target="fraSubmit">
...
<table class=common align=center>
	...
	<TR>
		...
		<TD class=input><select name="TRANSCODE" style="background-color: #D7E1F6">
			    <option value="P53819176">查询客户保单</option>
			</select></TD>
...
<table class=common align=center>
	...
	<TR class=common>
		...
		<TD class=input><Input class=input name="mPlchd_Crdt_No"/>必填</TD>
	</TR>
	<TR class=common>
		<TD class=title>投保人名称</TD>
		<TD class=input><Input class=input name="mPlchd_Nm"/>必填</TD>
	...
	<TR class=common>
		...
		<TD class=title>开始记录数</TD>
		<TD class=input><Input class=input name="m__BEGIN_REC"/></TD>
	</TR>
	<TR class=common>
		<TD class=title>一次查询最大记录数</TD>
		<TD class=input><Input class=input name="m__MAX_REC"/></TD>
		<TD class=title>查询开始日期</TD>
		<TD class=input><Input class="coolDatePicker" dateFormat="short" name="mQRY_START_DT">必填</TD>
	</TR>
	<TR class=common>
		<TD class=title>查询结束日期</TD>
		<TD class=input><Input class="coolDatePicker" dateFormat="short" name="mQRY_END_DT">必填</TD>
		<TD class=title>建行账号</TD>
		<TD class=input><Input class=input name="mCCB_AccNo"/></TD>
	</TR>
	<TR class=common>
		<TD class=title>投保操作人编号</TD>
		<TD class=input><Input class=input name="mIns_Mnplt_Psn_ID"/></TD>
	</TR>
</table>
