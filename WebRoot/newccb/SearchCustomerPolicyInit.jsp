...
function initForm()
{
	...
	{
		alert("SearchInsuInformationInit.jsp-->InitForm11 函数中发生异常:初始化界面错误!");
	}
}
...
function initInputBox() 
{
	...
	fm.port.value = '39871'; 
	fm.TRANSCODE.value = 'P53819176'; 

	}
	catch(re)
	{
		alert("SearchInsuInformationInit.jsp-->initInputBox22 函数中发生异常:初始化界面错误!");
	}
}
...
function initBox(){
	...
	fm.TRANSCODE.value = 'P53819176'; 
		...
		alert("SearchInsuInformationInit.jsp-->initBox()函数中发生异常：初始化错误！");
	}
