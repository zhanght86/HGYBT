...
<script type="text/javascript">
		...
		<%@include file="QueryRenewalFeeInit.jsp"%>  

		<title>银保通测试</title>
	</head>
<body onload="initElementtype();initForm();">
<form action="./QueryRenewalFeeSave.jsp" method=post name=fm target="fraSubmit">
...
<table class=common align=center>
	...
	<TR>
		...
		<TD class=input><select name="TRANSCODE" style="background-color: #D7E1F6">
			    <option value="P53819151">查询缴纳保费信息</option>
			</select></TD>
...
<table class=common align=center>
	...
	<TR class=common>
		...
		<TD class=input><Input class=input name="mIns_BillNo"/></TD>
	...
	<TR class=common>
		...
		<TD class=input><Input class="coolDatePicker" name="mPlchd_Crdt_EfDt"></TD>
		<TD class=title>投保人证件失效日期</TD>
		<TD class=input><Input class="coolDatePicker" name="mPlchd_Crdt_ExpDt"></TD>
	</TR>
	<TR class=common>
		<TD class=title>投保人国籍代码</TD>
		<TD class=input>
			<select name="mPlchd_Nat_Cd" style="background-color: #D7E1F6">
