...
function initForm()
{
	...
	{
		alert("ConfirmRenewalFeeInit.jsp-->InitForm11 函数中发生异常:初始化界面错误!");
	}
}
...
fm.ip.value = '127.0.0.1';
	fm.port.value = '39871'; 
	fm.TRANSCODE.value = 'P53819156'; 

	}
	catch(re)
	{
		alert("ConfirmRenewalFeeInit.jsp-->initInputBox22 函数中发生异常:初始化界面错误!");
	}
}
...
function initBox(){
	...
	fm.TRANSCODE.value = 'P53819156'; 
		...
		alert("ConfirmRenewalFeeInit.jsp-->initBox()函数中发生异常：初始化错误！");
	}
