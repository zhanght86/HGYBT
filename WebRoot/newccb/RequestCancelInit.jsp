...
function initForm()
{
	...
	{
		alert("RequestCancelInit.jsp-->InitForm11 函数中发生异常:初始化界面错误!");
	}
}
...
function initInputBox() 
{
	...
	fm.port.value = '39871'; 
	fm.TRANSCODE.value = 'P53819143'; 

	}
	catch(re)
	{
		alert("RequestCancelInit.jsp-->initInputBox22 函数中发生异常:初始化界面错误!");
	}
}
...
function initBox(){
	...
	fm.TRANSCODE.value = 'P53819143'; 
		...
		alert("RequestCancelInit.jsp-->initBox()函数中发生异常：初始化错误！");
	}
