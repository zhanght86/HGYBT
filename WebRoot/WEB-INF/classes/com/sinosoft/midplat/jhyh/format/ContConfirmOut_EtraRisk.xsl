			...
			<Transaction_Body>
				...
				<Detail_List>
				 ...
				 <Detail_List>
					...
					<Detail>
					 ...
					 <BkDetail1/>
					 <BkDetail1><xsl:text>           </xsl:text>保险合同号：<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_(TranData/Body/ContNo, 50)"/><xsl:text></xsl:text>基本保险金额： <xsl:value-of select="$Amnt"/></BkDetail1>
					 <BkDetail1><xsl:text>           </xsl:text>险种名称：<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_($tRisk/RiskName, 52)"/>货币单位：人民币/元</BkDetail1>
					 <BkDetail1><xsl:text>           </xsl:text>------------------------------------------------------------------------------------------------</BkDetail1>
					 <BkDetail1><xsl:text>                    </xsl:text>  保单年度末  现金价值  | 保单年度末  现金价值  | 保单年度末  现金价值</BkDetail1>
				     <BkDetail1><xsl:text>           </xsl:text>------------------------------------------------------------------------------------------------</BkDetail1>
					 <xsl:text></xsl:text>           <xsl:apply-templates select="/TranData/Body/Risk[RiskCode!=MainRiskCode]/CashValues"/>
				...
				<Detail_List>
					...
					<Detail>
						   ...
						   <BkDetail1><xsl:text>           </xsl:text><xsl:text>书，确认已了解并认可保险合同的全部内容，知晓本人的权利和义务。</xsl:text></BkDetail1>
