  ...
  <TX>
   ...
   <TX_BODY>
	  <COMMON>
		...
		<FILE_INFO>
		<!-- 文件信息 -->
		<FILE_NAME><xsl:value-of select="RetData/FileName"/></FILE_NAME>
		<!-- 文件路径 -->
		<FILE_PATH><xsl:value-of select="RetData/FilePath"/></FILE_PATH>
		</FILE_INFO>
	    </FILE_LIST_PACK>
	  </COMMON>
	  <ENTITY>
         ...
         <APP_ENTITY>
           <NRlTmInsPlyDtlTot_Num><xsl:value-of select="LCCont/ContNum"/></NRlTmInsPlyDtlTot_Num>
         </APP_ENTITY>
	   </ENTITY>
	 </TX_BODY>
  </TX>
