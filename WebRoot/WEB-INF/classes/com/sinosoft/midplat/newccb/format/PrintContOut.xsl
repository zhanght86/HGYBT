			       ...
			       <!-- 	<Ret_File_Num><xsl:value-of select="/TranData/Body/Ret_File_Num"/></Ret_File_Num> --> 	
					...
					<!-- 	<xsl:for-each select="/TranData/Body/Detail_List">
							...
							<Detail_List>
								...
								<Ret_Inf><xsl:text>　</xsl:text></Ret_Inf>
								<Ret_Inf><xsl:text>　</xsl:text></Ret_Inf> 
								<Ret_Inf><xsl:text>　</xsl:text>保险合同号2：<xsl:value-of select="/TranData/Body/ContNo"/><xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_(' ', 48)"/>货币单位：人民币/元 </Ret_Inf>
								<Ret_Inf><xsl:text>　</xsl:text>------------------------------------------------------------------------------------------------</Ret_Inf>
								<Ret_Inf/>
