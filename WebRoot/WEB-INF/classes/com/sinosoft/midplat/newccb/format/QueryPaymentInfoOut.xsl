	...
	<TX>
		...
		<TX_BODY>
   			...
   			<ENTITY>
	        	<APP_ENTITY>
					<!-- 投保单号 -->
					<xsl:variable name="tPrtNo" select="/TranData/LCCont/PrtNo"></xsl:variable>
					<Ins_BillNo><xsl:value-of select="substring($tPrtNo,1,13)"/></Ins_BillNo>
					<!-- 险种编号 -->
					...
					<!-- 代理保险缴费业务细分代码 -->
					<AgInsPyFBsnSbdvsn_Cd>12</AgInsPyFBsnSbdvsn_Cd>
	        	</APP_ENTITY>
	        </ENTITY>
      	</TX_BODY>
	</TX>
