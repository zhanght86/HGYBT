...
<xsl:stylesheet version="1.0"
	...
	<xsl:template name="Body" match="TranData/Body">
		<APP_ENTITY>
			<AgIns_Rcv_ADdBhBgNum><xsl:value-of select="BatIncome"></xsl:value-of></AgIns_Rcv_ADdBhBgNum><!-- 代理保险接收代扣批量包个数 -->
			<Rcv_SPyBhBgNum><xsl:value-of select="BatPay"></xsl:value-of></Rcv_SPyBhBgNum><!-- #接收代付批量包个数-->
		</APP_ENTITY>
</xsl:template>
</xsl:stylesheet>