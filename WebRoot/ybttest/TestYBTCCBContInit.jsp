...
//投保人信息
	//投保人姓名
	fm.AppFullName.value = '胡汉三';
	//投保人性别
	fm.AppGender.value = '1';
	//投保人证件类型
	fm.AppGovtIDTC.value = 'B';
	//投保人证件号码
	fm.AppGovtID.value = '3103148';
	//投保人生日
	...
	fm.AppWorkAddress.value='上海市浦东新区陆家嘴858号';
	fm.AppWorkZipCode.value='201206';
	fm.WorkPhone.value='02187654321';
	fm.PbInCome.value='250000.00';
	fm.PbHomeInCome.value='460000.00';
	
//被保人信息
	//被保人姓名
	fm.InsFullName.value = '无情'+<%=InsNumber%>;
	//被保人性别
...
//主险信息
	//主险代码 
	fm.ProductCode.value = '0001';
	//主险名称
	fm.RiskCodeName.value = '';
	//份数 
	fm.IntialNumberOfUnits.value = '30';
	//保费 
