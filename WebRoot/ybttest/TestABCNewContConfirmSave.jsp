...
<%
 ...
 System.out.println("****************银行端信息1*******************银行端信息1*******************");
	...
	//*银行交易时间
	String BankTime	= DateUtil.getCur8Time(); 
	//*银行代码
	...
	//新保交费特有字段
	//投保申请流水号
	String ReqsrNo = request.getParameter("ReqsrNo");
	//保费
	String Prem02	= request.getParameter("Prem02");
 ...
 ElementLis Req = new ElementLis("Req");	 	  
	...
	ElementLis InsuIDEle = new ElementLis("InsuID",InsuID,Req);
		ElementLis Base = new ElementLis("Base",Req);
			...
			ElementLis ReqsrNoEle = new ElementLis("ReqsrNo",ReqsrNo,Base);
			ElementLis Prem02Ele = new ElementLis("Prem",Prem02,Base);
...
<script language="javascript">
   ...
   parent.fraInterface.fm.02Prem.value = '<%=returnPrem%>';
