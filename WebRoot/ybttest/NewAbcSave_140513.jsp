...
//把保单信息在页面显示
 ...
 System.out.println(sBNFIDKIND1+"************************装载XML************************"+"========"+xmlContent);		 
 	...
 	ElementLis mReq = new ElementLis("Req",mApp);
 		...
 		ElementLis mAppNo = new ElementLis("AppNo",sSERIALNO,mReq);
 	...
 	//受益人
 		...
 		ElementLis mRisks = new ElementLis("Risks",mReq);
 			...
 			ElementLis rRiskBeginDate = new ElementLis("RiskBeginDate",null,mRisks);
 			ElementLis rRiskEndDate = new ElementLis("RiskEndDate",null,mRisks);
 	    ...
 	    String sAPPNOSer = request.getParameter("ReqsrNo");
 		...
 		ElementLis PolicyNo = new ElementLis("PolicyNo",null,mReq);
 	}
