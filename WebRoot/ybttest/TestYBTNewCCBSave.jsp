...
////modefied by zhoupan 20120710
  try {
	...
	String mPlchdFixTelDmstDstcNo = request.getParameter("PlchdFixTelDmstDstcNo");
	String mPlchdMoveTelItlDstcNo = request.getParameter("PlchdMoveTelItlDstcNo");
	String mPlchd_Nat_Cd = request.getParameter("Plchd_Nat_Cd");
	...
	String mRcgnFixTelDmst_DstcNo = request.getParameter("RcgnFixTelDmst_DstcNo");
	String mRcgnMoveTelItnlDstcNo = request.getParameter("RcgnMoveTelItnlDstcNo");
	String mRcgn_Nat_Cd = request.getParameter("Rcgn_Nat_Cd");
	...
	//受益人详细地址
	String sBnfAdressContent1 = request.getParameter("BnfAdressContent1");
	//受益百分数
	...
	//受益人详细地址
	String sBnfAdressContent2 = request.getParameter("BnfAdressContent2");
	//受益人证件生效日期
	...
	//受益人详细地址
	String sBnfAdressContent3 = request.getParameter("BnfAdressContent3");
	//受益人证件生效日期
...
ElementLis  cmPlchd_Nat_Cd= new ElementLis("Plchd_Nat_Cd",mPlchd_Nat_Cd,APP_ENTITY);
...
ElementLis Rcgn_LvFr_Pps_Lnd = new ElementLis("Rcgn_LvFr_Pps_Lnd",sDestinations,Pps_Detail);
	ElementLis  cmRcgn_Prov_Cd= new ElementLis("Rcgn_Prov_Cd",mPlchd_Prov_Cd,APP_ENTITY);
		...
		ElementLis  cmRcgnFixTelDmst_DstcNo= new ElementLis("RcgnFixTelDmst_DstcNo",mRcgnFixTelDmst_DstcNo,APP_ENTITY);
		ElementLis  cmRcgnMoveTelItnlDstcNo= new ElementLis("RcgnMoveTelItnlDstcNo",mRcgnMoveTelItnlDstcNo,APP_ENTITY);
		ElementLis  cmRcgn_Nat_Cd= new ElementLis("Rcgn_Nat_Cd",mRcgn_Nat_Cd,APP_ENTITY);
...
ElementLis Benf_Dtl_Adr_Cntnt = new ElementLis("Benf_Dtl_Adr_Cntnt",sBnfAdressContent1,Benf_Detail); 
BenefitNum++;
}
//如果有第二受益人 									
if(!(sBnfFullName2==null||sBnfFullName2.equals(""))){
	...
	ElementLis Benf_Dtl_Adr_Cntnt = new ElementLis("Benf_Dtl_Adr_Cntnt",sBnfAdressContent2,Benf_Detail); 
	BenefitNum++;
}
//如果有第三受益人 									 
if(!(sBnfFullName3==null||sBnfFullName3.equals(""))){
	...
	ElementLis Benf_Dtl_Adr_Cntnt = new ElementLis("Benf_Dtl_Adr_Cntnt",sBnfAdressContent3,Benf_Detail); 
	BenefitNum++;
}
