...
<table class=common align=center>
	...
	<TR class=common>
		...
		<TD class=title>首期缴费帐号(承保时录入)</TD>
		<TD class=input><Input class=input name="PayAccount" id="PayAccountID"/></TD>
	</TR>
	</TR>
	<%-- **************贷款信息****** --%>	
</table>
...
<table class=common align=center>
	...
	<TR class=common>
		...
		<TD class=input><Input class=input name="APPLANNUALINCOME"/></TD>
	...
	<TR class=common>
		...
		<TD class=input>
			<select name="APPLRELATOINSURED" style="background-color: #D7E1F6" onchange="WAppFlag(this.options[this.options.selectedIndex].value)">
				...
				<option value="03"> 妻子</option>
				<option value="04"> 父亲</option>
				<option value="05"> 母亲</option>	
				<option value="06"> 儿子</option>	 
				<option value="07"> 女儿</option>
