...
function setRiskFlag(c){
	if(c.checked == true){
		...
		<%@include file="JHYHContInit.jsp"%>  

		<title>银保通新契约测试</title>
	</head>
<body onload="initElementtype();initForm();">
<form action="./JHYHSave.jsp" method=post name=fm target="fraSubmit">
	...
	<TR class=common>
		...
		<TD class=input>
			<select name="AppToInsRelation" style="background-color: #D7E1F6">
				...
				<option value="04">祖父 </option>
				<option value="04">祖母</option>	 
				 <option value="04"> 孙子</option>
				<option value="04"> 孙女</option>
				<option value="04"> 外祖父</option>
				<option value="04"> 外祖母</option>
				<option value="04"> 外孙</option>
				<option value="04"> 外孙女</option>
				<option value="06"> 哥哥</option>
				<option value="06"> 姐姐</option>
				<option value="06"> 弟弟</option>	 
				 <option value="06"> 妹妹</option>
				<option value="06"> 公公</option>
				<option value="06"> 婆婆</option>
				<option value="06"> 儿媳</option>
				<option value="06"> 岳父</option>
				<option value="06"> 岳母</option>
				<option value="06"> 女婿</option>
				<option value="06"> 其它亲属 </option>
				<option value="06"> 同事 </option>	 
				 <option value="06"> 朋友 </option>
				<option value="06"> 雇主</option>
...
<td class=title>投保人职业代码</td>  
	...
	<TR class=common>
		...
		<TD class=input><Input class=input name=PbInCome><font color="red">元(两位小数点，如2000.00)</font></TD>
		<td class=title>投保人家庭年收入</td>
		<TD class=input><Input class=input name=PbHomeInCome><font color="red">元(两位小数点，如2000.00)</font></TD>
	</tr>
	<TR class=common>
	...
	<tr class=common2>
            <td bgColor="#F7F7F7">
			 <select name="ProductCode"  style="background-color: #D7E1F6" onchange="RiskFlag(this.options[this.options.selectedIndex].value)"> 
            	<option value="0001">中韩智赢财富两全保险（分红型）C款</option>
            	<option value="0002">中韩安赢借款人意外伤害保险A款</option>
            	<option value="0003">中韩保驾护航两全保险A款</option>
            	<option value="0004">中韩永利年年年金保险（分红型）</option>
                <option value="0005">中韩悦无忧两全保险</option>
                <option value="0006">中韩附加悦无忧重大疾病保险</option>
	...
	<tr class=common2>
		<td bgColor="#F7F7F7">
			<select name="ProductCode2"  style="background-color: #D7E1F6">
				<option value=""></option>
            	<option value="0000">暂不支持两个附加险</option>
            </select></td>
...
<div id="C20001" style="display:'none'">
	...
	<TR class=common>
		...
		<TD class=input><Input class=input name="LoanNo" id="LoanNo"></TD>
		<td class=title>贷款账号</td>
		<TD class=input>
			<input class=input  name = "AccNo"></TD>
	</tr> 
	
	<TR class=common> 
		<td class=title>贷款起始日期</td>
		<TD class=input>
			<input  class="coolDatePicker"   dateFormat = "short" name = "LoanDate"></TD>
	...
	<TR class=common>
		...
		<TD class=input><Input class=input name=LoanPrem id="LoanPrem"><font color="red">(单位：元)</font></TD>
...
<table class=common align=center>
    ...
    <TR class=common>
		<td class=title>首期缴费帐号<font color="red">(承保时填写)</font></td>
		<TD class=input><Input class="input"  name="BkAcctNo" ></TD>
		<td class=title>首期缴费方式<font color="red">(承保时填写)</font></td>
		<TD class=input>
...
<table class=common align=center>
	...
	<TR>
		...
		<select name="tranFlagCode"   style="background-color: #D7E1F6" onchange="TranFlag(this.options[this.options.selectedIndex].value)">
			    <option selected="selected" value="510015">新单试算</option>
			    <option value="510001">新单承保</option>
			</select></TD>
