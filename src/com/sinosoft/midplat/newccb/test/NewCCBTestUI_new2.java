 ...
 * @author yuantongxin
 */
public class NewCCBTestUI_new2 {
...
//		funcflag="P53819161";
		//输入文件路径
		String mInFilePath = "D:/task/20161216/newccb/core_test/11092_1314_1012_in.xml";
...
//		      mInFilePath = "D:/task/20161129/newccb/P53819161_修改保单基本信息.xml";
			//输出文件路径
		    String mOutFilePath = "D:/task/20161216/newccb/core_test/"+funcflag+"out_noStd.xml";
		    //建设银行测试新用户界面类通过网络之间互连的协议、端口号实例化
			NewCCBTestUI_new2 mTestUI = new NewCCBTestUI_new2(mIP,	mPort);
			//通过文件输入流实例化输入流
			...
			PrintWriter mFos = new PrintWriter(mOutFilePath);
			//为输出文件流提供“缓冲功能”
			BufferedWriter bufferedOutputStream=new BufferedWriter(mFos);
		    //得到漂亮的格式
	...
	public NewCCBTestUI_new2(String pIP, int pPort) {
		cIP = pIP;
		cPort = pPort;
	}
