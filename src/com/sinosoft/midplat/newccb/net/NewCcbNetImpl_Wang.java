...
public class NewCcbNetImpl_Wang extends SocketNetImpl {
...
//	private String mIns_Co_ID = "";
	...
	public NewCcbNetImpl_Wang(Socket pSocket, Element pThisConfRoot)
	...
	public Document receive() throws Exception {
		...
		// 解析安全报文头及报文体
		Object[] recv = SecurityMessageHeaderUtils.ummarshal(mDataStr.getBytes(),
...
//		String dataStr = responseData.toString();
//		int TXindex = dataStr.indexOf("TX");
		
//		responseData = dataStr.getBytes();
		//获得报文体数据
...
//		cLogger.info("mSYS_TX_CODE: "+mSYS_TX_CODE);
...
//		JdomUtil.print(cThisConfRoot);
		...
		StringBuffer mSaveName = new StringBuffer(Thread.currentThread().getName())		
			.append('_').append(NoFactory.nextAppNo()).append('_').append(cFuncFlag).append("_in.xml");
...
//		cLogger.info("保险公司编码："+cXmlDoc.getRootElement().getChild("TX_BODY").getChild("ENTITY").getChild("COM_ENTITY").getChildText("Ins_Co_ID"));
		...
		//拼装安全报文头及报文体
		byte[] outSec =
				SecurityMessageHeaderUtils.marshal(header, mXmlBytes, true);
		...
		sb_http.append("Date: (2014-8-13 10:44:05)\r\n");
