...
public class P53819145 extends XmlSimpFormat {
	...
	public P53819145(Element pThisBusiConf) {
		super(pThisBusiConf);
	}
	@Override
	public Document noStd2Std(Document pNoStdXml) throws Exception {
		cLogger.info("Into P53819145.noStd2Std()...");
		//服务接受时间
		...
		Document mStdXml = 
			P53819145InXsl.newInstance().getCache().transform(pNoStdXml);
		cLogger.info("Out P53819145.noStd2Std()!");
		return mStdXml;
	}
	
	@Override
	public Document std2NoStd(Document pStdXml) throws Exception {
		cLogger.info("Into P53819145.Std2StdnoStd()...");
		Document mNoStdXml ;
		mNoStdXml = P53819145OutXsl.newInstance().getCache().transform(pStdXml);
		//服务响应时间
		...
		cLogger.info("Out P53819145.std2NoStd()!");
		return mNoStdXml;
	}
	...
	public static void main(String[] args) throws Exception{
	    ...
	    String mInFilePath = "C:\\Users\\PengYF\\Desktop\\sinosoft\\HG\\ccb\\申请契撤.xml";
