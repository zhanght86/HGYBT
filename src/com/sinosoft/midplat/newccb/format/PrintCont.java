...
public class PrintCont extends XmlSimpFormat{
	...
	public PrintCont(Element pThisConf) {
		super(pThisConf);
	}
...
//		JdomUtil.print(cTransaction_Header);
		...
		Document mStdXml = 
			PrintContInXsl.newInstance().getCache().transform(pNoStdXml);
	...
	public Document std2NoStd(Document pStdXml) throws Exception {
		...
		if (ttFlag.getValue().equals("0")){
			...
			if("221301".equals(tRiskCode.getValue())){
			   pStdXml =  dealCashValues2(pStdXml);
				...
				tXslName="PrintContOut_PensionCash";
				...
				tXslName="PrintContOut_AlmightyRisk";
			}else{
		...
		Document mNoStdXml = 
			PrintContOutXsl.newInstance(tXslName).getCache().transform(pStdXml);
