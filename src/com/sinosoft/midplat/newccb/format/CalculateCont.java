...
public class CalculateCont extends XmlSimpFormat {
	...
	public CalculateCont(Element pThisConf) {
		super(pThisConf);
	}
	
	public Document noStd2Std(Document pNoStdXml) throws Exception {
		cLogger.info("Into CalculateCont.noStd2Std()...");
...
//		JdomUtil.print(cTransaction_Header);
		...
		Document mStdXml = 
			CalculateContInXsl.newInstance().getCache().transform(pNoStdXml);
		
		cLogger.info("Out CalculateCont.noStd2Std()!");
		return mStdXml;
	}

	public Document std2NoStd(Document pStdXml) throws Exception {
		cLogger.info("Into CalculateCont.std2NoStd()...");
...
//		mIs2.close();
		...
		Document mNoStdXml = 
			CalculateContOutXsl.newInstance().getCache().transform(pStdXml);
...
//		}
		...
		cLogger.info("Out CalculateCont.std2NoStd()!");
		return mNoStdXml;
	}
//	public static void main(String[] args) throws Exception {
//		System.out.println("程序开始…");
//
////		String mInFilePath = "H:/李路/模拟建行报文/ccb_CCB000000000111111_P53819151_134728.xml";
////		String mOutFilePath = "H:/李路/模拟建行报文/P53819151inSvc.xml";
//		String mInFilePath = "H:/李路/任务/P53816141InNoStd.xml";
//		String mOutFilePath = "H:/李路/任务/P53816141inSvcStd.xml";
//
//		InputStream mIs = new FileInputStream(mInFilePath);
//		Document mInXmlDoc = JdomUtil.build(mIs);
//		mIs.close();
//
////		Document mOutXmlDoc = new CalculateCont(null).std2NoStd(mInXmlDoc);
//		Document mOutXmlDoc = new CalculateCont(null).noStd2Std(mInXmlDoc);
//
