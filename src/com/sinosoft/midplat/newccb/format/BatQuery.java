...
public class BatQuery extends XmlSimpFormat {
	...
	public BatQuery(Element pThisConf) {
		super(pThisConf);
	}
...
//		JdomUtil.print(cTransaction_Header);
		...
		Document mStdXml = BatQueryInXsl.newInstance().getCache().transform(pNoStdXml);
	...
	public Document std2NoStd(Document pStdXml) throws Exception {
		...
		Document mNoStdXml = BatQueryOutXsl.newInstance().getCache().transform(pStdXml);
