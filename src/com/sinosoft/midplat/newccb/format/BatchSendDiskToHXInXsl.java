...
public class BatchSendDiskToHXInXsl extends XslCache {

		//实时投保输入报文样式实例
		private static BatchSendDiskToHXInXsl cThisIns = new BatchSendDiskToHXInXsl();
		
		private String cPath = "com/sinosoft/midplat/newccb/format/BatchSendDiskToHXIn.xsl";
		
		/**
		 * 实时投保输入报文样式构造器
		 */
		private BatchSendDiskToHXInXsl() {
			//加载XSL文件
			load();
			//配置文件缓存管理系统实例注册XSL路径
		...
		public void load() {
			...
			cLogger.info("Into BatResponseToHXInXsl.load()...");
			...
			cLogger.info("Out BatResponseToHXInXsl.load()!");
		}
		 ...
		 * @return
		 */
		public static BatchSendDiskToHXInXsl newInstance() {
			return cThisIns;
		}
