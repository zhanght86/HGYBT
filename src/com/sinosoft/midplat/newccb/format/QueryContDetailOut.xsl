...
<xsl:stylesheet version="1.0"
			...
			<TX_BODY>
				...
				<ENTITY>
					<APP_ENTITY>
						...
						<!-- 投保人出生日期 -->
						<Plchd_Brth_Dt>
							<xsl:value-of select="/TranData/Body/Appnt/BirthDay" />
						</Plchd_Brth_Dt>
						<!-- 投保人证件类型代码 -->
						<Plchd_Crdt_TpCd>
							<xsl:call-template name="tran_idtype">
								<xsl:with-param name="idtype">
									<xsl:value-of select="/TranData/Body/Appnt/IDType" />
								</xsl:with-param>
							</xsl:call-template>
						</Plchd_Crdt_TpCd>
						<!-- 投保人证件号 -->
						...
						<!-- 投保人详细地址内容 -->
						<Plchd_Dtl_Adr_Cntnt><xsl:value-of select="/TranData/Body/Appnt/AddressContent" /></Plchd_Dtl_Adr_Cntnt>
						<!-- 投保人固定电话国际区号 -->
						<PlchdFixTelItnlDstcNo></PlchdFixTelItnlDstcNo>
						<!-- 投保人固定电话国内区号 -->
						<PlchdFixTelDmstDstcNo><xsl:value-of select="/TranData/Body/Appnt/FixTelDmstDstcNo" /></PlchdFixTelDmstDstcNo>
						<!--  投保人移动电话国际区号-->
						<PlchdMoveTelItlDstcNo><xsl:value-of select="/TranData/Body/Appnt/MobileItlDstcNo" /></PlchdMoveTelItlDstcNo>
						<!-- 投保人国籍代码 -->
						<Plchd_Nat_Cd>
							<xsl:call-template name="tran_Nationality">
								<xsl:with-param name="Nationality">
									<xsl:value-of select="/TranData/Body/Appnt/Nationality" />
								</xsl:with-param>
							</xsl:call-template>
						</Plchd_Nat_Cd>
						<!-- 投保人通信地址 -->
						<Plchd_Comm_Adr>
							<xsl:value-of select="/TranData/Body/Appnt/Address" />
						</Plchd_Comm_Adr>
						<!-- 投保人邮政编码 -->
						<Plchd_ZipECD>
							<xsl:value-of select="/TranData/Body/Appnt/ZipCode" />
						</Plchd_ZipECD>
						<!-- 投保人固定电话 -->
						<Plchd_Fix_TelNo>
							<xsl:value-of select="/TranData/Body/Appnt/Phone" />
						</Plchd_Fix_TelNo>
						<!-- 投保人移动电话 -->
						<Plchd_Move_TelNo>
							<xsl:value-of select="/TranData/Body/Appnt/Mobile" />
						</Plchd_Move_TelNo>
						<!-- 投保人电子邮件地址 -->
						<Plchd_Email_Adr>
							<xsl:value-of select="/TranData/Body/Appnt/Email" />
						</Plchd_Email_Adr>
						<!-- 投保人职业代码 核心部分职业代码，暂时随便写 -->
						<Plchd_Ocp_Cd>Y0000</Plchd_Ocp_Cd>
						<!-- 投保人年收入 -->
						...
						<Plchd_And_Rcgn_ReTpCd>
							<xsl:if test = "/TranData/Body/Appnt/RelaToInsured = '00'">0133043</xsl:if>
							<xsl:if test = "/TranData/Body/Appnt/RelaToInsured = '02'">0133010</xsl:if>
							<xsl:if test = "(/TranData/Body/Appnt/RelaToInsured = '01') and (/TranData/Body/Insured/Sex = '0')">0133011</xsl:if>
							<xsl:if test = "(/TranData/Body/Appnt/RelaToInsured = '01') and (/TranData/Body/Insured/Sex = '1')">0133012</xsl:if>
							<xsl:if test = "(/TranData/Body/Appnt/RelaToInsured = '03') and (/TranData/Body/Insured/Sex = '0')">0133015</xsl:if>
							<xsl:if test = "(/TranData/Body/Appnt/RelaToInsured = '03') and (/TranData/Body/Insured/Sex = '1')">0133016</xsl:if>
							<xsl:if test = "/TranData/Body/Appnt/RelaToInsured = '06'">0133010</xsl:if>
						</Plchd_And_Rcgn_ReTpCd>

						<!-- 被保人姓名 -->
						<Rcgn_Nm>
							<xsl:value-of select="/TranData/Body/Insured/Name" />
						</Rcgn_Nm>
						<!-- 被保人拼音全称 -->
						...
						<Rcgn_Gnd_Cd>
							<xsl:call-template name="tran_sex">
								<xsl:with-param name="Sex">
									<xsl:value-of select="/TranData/Body/Insured/Sex" />
								</xsl:with-param>
							</xsl:call-template>
						</Rcgn_Gnd_Cd>
						<!-- 被保人出生日期 -->
						<Rcgn_Brth_Dt>
							<xsl:value-of select="/TranData/Body/Insured/BirthDay" />
						</Rcgn_Brth_Dt>
						<!-- 被保人证件类型代码 -->
						<Rcgn_Crdt_TpCd>
							<xsl:call-template name="tran_idtype">
								<xsl:with-param name="idtype">
									<xsl:value-of select="/TranData/Body/Insured/IDType" />
								</xsl:with-param>
							</xsl:call-template>
						</Rcgn_Crdt_TpCd>
						<!-- 被保人证件号 -->
						...
						<!-- 被保人详细地址内容 -->
						<Rcgn_Dtl_Adr_Cntnt><xsl:value-of select="/TranData/Body/Insured/AddressContent" /></Rcgn_Dtl_Adr_Cntnt>
						<!-- 被保人固定电话国际区号 -->
						<RcgnFixTelItnl_DstcNo></RcgnFixTelItnl_DstcNo>
						<!-- 被保人固定电话国内区号 -->
						<RcgnFixTelDmst_DstcNo><xsl:value-of select="/TranData/Body/Insured/FixTelDmstDstcNo" /></RcgnFixTelDmst_DstcNo>
						<!--  被保人移动电话国际区号-->
						<RcgnMoveTelItnlDstcNo><xsl:value-of select="/TranData/Body/Insured/MobileItlDstcNo" /></RcgnMoveTelItnlDstcNo>
						<!-- 被保人国籍代码 -->
						<Rcgn_Nat_Cd>
							<xsl:call-template name="tran_Nationality">
								<xsl:with-param name="Nationality">
									<xsl:value-of select="/TranData/Body/Insured/Nationality" />
								</xsl:with-param>
							</xsl:call-template>
						</Rcgn_Nat_Cd>
						<!-- 被保人通讯地址 -->
						<Rcgn_Comm_Adr>
							<xsl:value-of select="/TranData/Body/Insured/Address" />
						</Rcgn_Comm_Adr>
						<!-- 被保人邮政编码 -->
						<Rcgn_ZipECD>
							<xsl:value-of select="/TranData/Body/Insured/ZipCode" />
						</Rcgn_ZipECD>
						<!-- 被保人固定电话 -->
						<Rcgn_Fix_TelNo>
							<xsl:value-of select="/TranData/Body/Insured/Phone" />
						</Rcgn_Fix_TelNo>
						<!-- 被保人移动电话 -->
						<Rcgn_Move_TelNo>
							<xsl:value-of select="/TranData/Body/Insured/Mobile" />
						</Rcgn_Move_TelNo>
						<!-- 被保人电子邮件地址 -->
						<Rcgn_Email_Adr>
							<xsl:value-of select="/TranData/Body/Insured/Email" />
						</Rcgn_Email_Adr>
						<!-- 被保人职业代码 -->
						<Rcgn_Ocp_Cd>Y0000</Rcgn_Ocp_Cd>
						<!-- 被保人前往目的地个数 -->
						...
						<!-- 受益人个数 -->
						<Benf_Num>
							<xsl:value-of select="count(/TranData/Body/Bnf)" />
						</Benf_Num>
						<Benf_List>
							<!-- 受益人信息循环 -->
						...
						<!-- #循环记录条数 -->
						<Rvl_Rcrd_Num>
							<xsl:value-of select="count(/TranData/Body/Risk)" />
						</Rvl_Rcrd_Num>
						<Busi_List>
						...
						<!-- 投保人缴费账号 -->
						<Plchd_PyF_AccNo>
							<xsl:value-of select="/TranData/Body/AccNo" />
						</Plchd_PyF_AccNo>
						<!-- 投保人领取账号 -->
						<Plchd_Drw_AccNo></Plchd_Drw_AccNo>
						<!-- 被保人帐号 -->
						<Rcgn_AccNo>
							<xsl:value-of select="/TranData/Body/RcgnAccNo" />
						</Rcgn_AccNo>
						<!-- 受益人帐号 -->
						<Benf_AccNo>
							<xsl:value-of select="/TranData/Body/BenfAccNo" />
						</Benf_AccNo>
						<!-- 续期缴费支付方式代码 -->
						...
						<!-- 网点销售人员编码 -->
						<BO_Sale_Stff_ID>
							<xsl:value-of select="/TranData/Body/SaleStaff" />
						</BO_Sale_Stff_ID>
						<!-- 网点销售人员姓名 -->
						<BO_Sale_Stff_Nm>
							<xsl:value-of select="/TranData/Body/SaleName" />
						</BO_Sale_Stff_Nm>
						<!-- 销售人员代理保险从业人员资格证书编号 -->
						<Sale_Stff_AICSQCtf_ID>
							<xsl:value-of select="/TranData/Body/SaleCertNo" />
						</Sale_Stff_AICSQCtf_ID>
						<!-- 推荐客户经理编号 -->
	...
	<xsl:template name="tran_Nationality">
		...
		<xsl:if test="$Nationality = ''">344</xsl:if><!--香港 -->
		<xsl:if test="$Nationality = ''">158</xsl:if><!--台湾 -->
		<xsl:if test="$Nationality = ''">446</xsl:if><!--澳门 -->
		<xsl:if test="$Nationality = 'JAN'">392</xsl:if><!--日本 -->
		<xsl:if test="$Nationality = 'USA'">840</xsl:if><!--美国 -->
		<xsl:if test="$Nationality = ''">643</xsl:if><!--俄罗斯 -->
	...
	<xsl:template name="tran_relation">
		...
		<xsl:if test="$RelaToInsured = 03">0133015</xsl:if><!--父亲 -->
		<xsl:if test="$RelaToInsured = 03">0133016</xsl:if><!--母亲 -->
		<xsl:if test="$RelaToInsured = 01">0133011</xsl:if><!--儿子 -->
		<xsl:if test="$RelaToInsured = 01">0133012</xsl:if><!--女儿 -->
		<xsl:if test="$RelaToInsured = 06">0133021</xsl:if><!--其它亲属 -->
	</xsl:template>
	
		<!-- 关系 -->
	<xsl:template name="tran_Bnfrelation">
		<xsl:param name="BnfRelaToInsured"></xsl:param>
		<xsl:if test="$BnfRelaToInsured = 00">0133043</xsl:if><!--本人 -->
		<xsl:if test="$BnfRelaToInsured = 02">0133010</xsl:if><!--妻子 -->
		<xsl:if test="$BnfRelaToInsured = 01">0133015</xsl:if><!--父亲 -->
		<xsl:if test="$BnfRelaToInsured = 01">0133016</xsl:if><!--母亲 -->
		<xsl:if test="$BnfRelaToInsured = 03">0133011</xsl:if><!--儿子 -->
		<xsl:if test="$BnfRelaToInsured = 03">0133012</xsl:if><!--女儿 -->
		<xsl:if test="$BnfRelaToInsured = 06">0133021</xsl:if><!--其它亲属 -->
	</xsl:template>

	<!-- 保单的缴费方式 -->
	<xsl:template name="tran_Contpayintv">
		<xsl:param name="payintv">00</xsl:param>
		<xsl:choose>
	...
	<xsl:template name="tran_PbIYF">
		<xsl:param name="PbInsuYearFlag">05</xsl:param>
		<xsl:choose>
			<xsl:when test="$PbInsuYearFlag = 'M'">01</xsl:when>
			<xsl:when test="$PbInsuYearFlag = 'D'">02</xsl:when>
