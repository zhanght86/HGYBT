...
public class GetContList extends XmlSimpFormat {
	...
	public GetContList(Element pThisConf) {
		super(pThisConf);
	}
	
	public Document noStd2Std(Document pNoStdXml) throws Exception {
		cLogger.info("Into GetContList.noStd2Std()...");
...
//		JdomUtil.print(cTransaction_Header);
		...
		Document mStdXml = 
			GetContListInXsl.newInstance().getCache().transform(pNoStdXml);
	...
	public Document std2NoStd(Document pStdXml) throws Exception {
		cLogger.info("Into GetContList.std2NoStd()...");
	
		Document mNoStdXml = 
			GetContListOutXsl.newInstance().getCache().transform(pStdXml);
...
//		}
		...
		cLogger.info("Out GetContList.std2NoStd()!");
		return mNoStdXml;
	}
