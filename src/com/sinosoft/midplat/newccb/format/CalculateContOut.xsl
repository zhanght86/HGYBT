		...
		<!-- 报文体 -->
			<TX_BODY>
	      			...
	      			<ENTITY>
			        	<APP_ENTITY>
							<!-- 主险保额  -->
							<MainIns_Cvr><xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fenToYuan(/TranData/Body/Amnt)"/></MainIns_Cvr>
							<!-- 保费金额  -->
							<InsPrem_Amt><xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fenToYuan(/TranData/Body/Prem)"/></InsPrem_Amt>
			        	</APP_ENTITY>
			        </ENTITY>
	      	</TX_BODY>
		</TX>
