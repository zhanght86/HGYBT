...
public class BatchQuery extends XmlSimpFormat {
	...
	public BatchQuery(Element pThisConf) {
		super(pThisConf);
	}
	
	public Document noStd2Std(Document pNoStdXml) throws Exception {
		cLogger.info("Into BatchQuery.noStd2Std()...");
		...
		Document mStdXml = 
			BatchQueryInXsl.newInstance().getCache().transform(pNoStdXml);
		
		cLogger.info("Out BatchQuery.noStd2Std()!");
		return mStdXml;
	}
	
	public Document std2NoStd(Document pStdXml) throws Exception {
		cLogger.info("Into BatchQuery.std2NoStd()...");

		Document mNoStdXml = 
			BatchQueryOutXsl.newInstance().getCache().transform(pStdXml);
...
//		}
		...
		cLogger.info("Out BatchQuery.std2NoStd()!");
		return mNoStdXml;
	}
