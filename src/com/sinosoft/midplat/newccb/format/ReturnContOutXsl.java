...
public class ReturnContOutXsl extends XslCache {
	private static ReturnContOutXsl cThisIns = new ReturnContOutXsl();
	
	private String cPath = "com/sinosoft/midplat/newccb/format/ReturnContOut.xsl";
	
	private ReturnContOutXsl() {
		load();
	...
	public static ReturnContOutXsl newInstance() {
		return cThisIns;
	}
}