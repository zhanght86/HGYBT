...
public class ExpirationPay extends XmlSimpFormat {
	...
	public ExpirationPay(Element pThisConf) {
		super(pThisConf);
	}
	
	public Document noStd2Std(Document pNoStdXml) throws Exception {
		cLogger.info("Into ExpirationPay.noStd2Std()...");
...
//		JdomUtil.print(cTransaction_Header);
		...
		Document mStdXml = 
			ExpirationPayInXsl.newInstance().getCache().transform(pNoStdXml);
		
		cLogger.info("Out ExpirationPay.noStd2Std()!");
		return mStdXml;
	}

	public Document std2NoStd(Document pStdXml) throws Exception {
		cLogger.info("Into ExpirationPay.std2NoStd()...");
...
//		mIs2.close();		
		...
		Document mNoStdXml = 
			ExpirationPayOutXsl.newInstance().getCache().transform(pStdXml);
...
//		}
		...
		cLogger.info("Out ExpirationPay.std2NoStd()!");
		return mNoStdXml;
	}
...
//
////		String mInFilePath = "H:/李路/模拟建行报文/ccb_CCB000000000111111_P53819192_134728.xml";
////		String mOutFilePath = "H:/李路/模拟建行报文/P53819192inSvc.xml";
//		String mInFilePath = "H:/李路/任务/P53819192InNoStd.xml";
//		String mOutFilePath = "H:/李路/任务/P53819192inSvcStd.xml";
//
//		InputStream mIs = new FileInputStream(mInFilePath);
//		Document mInXmlDoc = JdomUtil.build(mIs,"UTF-8");
//		mIs.close();
//
////		Document mOutXmlDoc = new ExpirationPay(null).std2NoStd(mInXmlDoc);
//		Document mOutXmlDoc = new ExpirationPay(null).noStd2Std(mInXmlDoc);
//
