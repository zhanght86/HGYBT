...
public class CancleRenewalPay extends XmlSimpFormat {
	...
	public CancleRenewalPay(Element pThisConf) {
		super(pThisConf);
	}
	
	public Document noStd2Std(Document pNoStdXml) throws Exception {
		cLogger.info("Into CancleRenewalPay.noStd2Std()...");
...
//		JdomUtil.print(cTransaction_Header);
		...
		Document mStdXml = 
			CancleRenewalPayInXsl.newInstance().getCache().transform(pNoStdXml);
		
		cLogger.info("Out CancleRenewalPay.noStd2Std()!");
		return mStdXml;
	}

	public Document std2NoStd(Document pStdXml) throws Exception {
		cLogger.info("Into CancleRenewalPay.std2NoStd()...");

		//确认取消续期缴费无返回报文
		Document mNoStdXml = 
			CancleRenewalPayOutXsl.newInstance().getCache().transform(pStdXml);
...
//		}
		...
		cLogger.info("Out CancleRenewalPay.std2NoStd()!");
		return mNoStdXml;
	}
