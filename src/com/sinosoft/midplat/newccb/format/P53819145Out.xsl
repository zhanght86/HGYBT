	...
	<xsl:template match="TranData">
		<TX>
			...
			<TX_BODY>
				...
				<ENTITY>
				 <APP_ENTITY>
				   <Cvr_ID><xsl:value-of select="Body/RiskCode" /></Cvr_ID>
				   <Ins_BillNo><xsl:value-of select="Body/ConPrtNo"/></Ins_BillNo>
				   <Plchd_Nm><xsl:value-of select="Body/AppntName"/></Plchd_Nm>
				   <Rcgn_Nm><xsl:value-of select="Body/Name_List"/></Rcgn_Nm>
				   <Plchd_Crdt_TpCd></Plchd_Crdt_TpCd>
				   <Plchd_Crdt_No></Plchd_Crdt_No>
