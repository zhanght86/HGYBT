...
public class GetContList2 extends XmlSimpFormat
{
	...
	public Document std2NoStd(Document pStdXml) throws Exception
	{
        ...
        cLogger.info("----"+JdomUtil.toStringFmt(mNoStdXml));
		// 服务响应时间
		...
		mNoStdXml.getRootElement().getChild("TX_BODY").getChild("COMMON").getChild("FILE_LIST_PACK").getChild("FILE_INFO").getChild("FILE_PATH").setText(ccblocalPath.substring(0,ccblocalPath.length()-1));
