...
public class QueryCont extends XmlSimpFormat{
	...
	public QueryCont(Element pThisConf) {
		super(pThisConf);
	}
...
//		JdomUtil.print(cTransaction_Header);
		...
		Document mStdXml = 
			QueryContInXsl.newInstance().getCache().transform(pNoStdXml);
...
//		String mInFilePath2 = "E:/993912_5_1039_in.xml";
...
//		mIs2.close();		
		...
		Document mNoStdXml = 
			QueryContOutXsl.newInstance().getCache().transform(pStdXml);
...
//
////		String mInFilePath = "H:/李路/模拟建行报文/ccb_CCB000000000111111_P53819176_134728.xml";
////		String mOutFilePath = "H:/李路/模拟建行报文/P53819176inSvc.xml";
////		String mInFilePath = "D:/msg/03/2014/201408/20140811/646_10_35_outSvc.xml";
////		String mOutFilePath = "H:/李路/任务/P53819176.xml";
//		String mInFilePath = "E:/993912_7_35_outSvc.xml";
...
//		mIs.close();
//
//		Document mOutXmlDoc = new QueryCont(null).std2NoStd(mInXmlDoc);
////		Document mOutXmlDoc = new QueryCont(null).noStd2Std(mInXmlDoc);
//
