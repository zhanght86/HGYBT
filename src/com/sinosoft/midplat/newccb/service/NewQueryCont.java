...
public class NewQueryCont extends ServiceImpl
{
	public NewQueryCont(Element pThisBusiConf)
	{
		super(pThisBusiConf);
	}
	...
	public Document service(Document pInXmlDoc)
	{
		...
		cLogger.info("Into NewQueryCont.service()...");
		cInXmlDoc = pInXmlDoc;
		...
		try
		{
			...
			cOutXmlDoc = new CallWebsvcAtomSvc(AblifeCodeDef.SID_Bank_QueryCont).call(cInXmlDoc);
			System.out.println("-----------------------------------------------");
		...
		cLogger.info("Out NewQueryCont.service()!");
		return cOutXmlDoc;
	}

	private void rollback()
	{
		cLogger.debug("Into NewQueryCont.rollback()...");
		...
		cLogger.debug("Out NewQueryCont.rollback()!");
	}
