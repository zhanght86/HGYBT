...
public class PrintCont extends ServiceImpl{
	...
	public Document service(Document pInXmlDoc) {
		...
		cLogger.info("Into PrintCont.service()...");
		cInXmlDoc = pInXmlDoc;
...
//			cLogger.info("Into PrintCont.service()...-->authority(cInXmlDoc)网点与权限 添加代理");	
...
//			cTranLogDB.setContNo(tContDB.getContNo());
		...
		cLogger.info("Out PrintCont.service()!");
		return cOutXmlDoc;
	}
	
	private ContDB getContDB() {
		cLogger.debug("Into PrintCont.getContDB()...");
...
//JdomUtil.print(cOutXmlDoc);
		...
		cLogger.debug("Out PrintCont.getContDB()!");
		return mContDB;
	}
	
	private void rollback() {
		cLogger.debug("Into PrintCont.rollback()...");
		...
		cLogger.debug("Out PrintCont.rollback()!");
	}
	/**
	 * @param mInXmlDoc
	 * @return cInXmlDoc
