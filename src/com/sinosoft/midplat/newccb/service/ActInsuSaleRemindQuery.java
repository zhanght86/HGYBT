...
public class ActInsuSaleRemindQuery extends ServiceImpl {
	public ActInsuSaleRemindQuery(Element pThisBusiConf) {
		super(pThisBusiConf);
	}
	...
	public Document service(Document pInXmlDoc) {
		...
		cLogger.info("Into ActInsuSaleRemindQuery.service()...");
		cInXmlDoc = pInXmlDoc;
		...
		try {
			...
			cOutXmlDoc = new CallWebsvcAtomSvc(AblifeCodeDef.SID_ActInsuSaleRemindQuery).call(cInXmlDoc);

			cLogger.info("发送核心获取代理保险售后提醒查询报文完成 ");
		...
		cLogger.info("Out ActInsuSaleRemindQuery.service()!");
		return cOutXmlDoc;
	}
	
	
	private void rollback() {
		cLogger.debug("Into ActInsuSaleRemindQuery.rollback()...");
		...
		cLogger.debug("Out ActInsuSaleRemindQuery.rollback()!");
	}
	/**
	 * @param mInXmlDoc
	 * @return cInXmlDoc
