...
public class NewGetContList2_bak extends ServiceImpl {
	public NewGetContList2_bak(Element pThisBusiConf) {
		super(pThisBusiConf);
	}
...
//			cInXmlDoc = authority(cInXmlDoc); 	
	...
	private void rollback() {
		cLogger.debug("Into NewGetContList2.rollback()...");
		...
		cLogger.debug("Out NewGetContList2.rollback()!");
	}
	/**
	 * @param mInXmlDoc
	 * @return cInXmlDoc
