...
public class NewGetContList extends ServiceImpl {
	public NewGetContList(Element pThisBusiConf) {
		super(pThisBusiConf);
	}
	...
	public Document service(Document pInXmlDoc) {
		...
		cLogger.info("Into NewGetContList.service()...");
		cInXmlDoc = pInXmlDoc;
		...
		try {
			...
			cOutXmlDoc = new CallWebsvcAtomSvc(AblifeCodeDef.SID_Bank_GetContList).call(cInXmlDoc);

			cLogger.info("发送核心获取保单详情查询报文完成 ");
		...
		cLogger.info("Out NewGetContList.service()!");
		return cOutXmlDoc;
	}
	
	
	private void rollback() {
		cLogger.debug("Into NewGetContList.rollback()...");
		...
		cLogger.debug("Out NewGetContList.rollback()!");
	}
	/**
	 * @param mInXmlDoc
	 * @return cInXmlDoc
