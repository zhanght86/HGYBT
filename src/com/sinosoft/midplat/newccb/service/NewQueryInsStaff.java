...
public class NewQueryInsStaff extends ServiceImpl {
	public NewQueryInsStaff(Element pThisBusiConf) {
		super(pThisBusiConf);
	}
	...
	public Document service(Document pInXmlDoc) {
		...
		cLogger.info("Into NewQueryInsStaff.service()...");
		cInXmlDoc = pInXmlDoc;
...
//			cInXmlDoc = authority(cInXmlDoc); 	
			...
			cOutXmlDoc = new CallWebsvcAtomSvc(AblifeCodeDef.SID_Bank_QueryInsStaff).call(cInXmlDoc);
			System.out.println("-----------------------------------------------");
		...
		cLogger.info("Out NewQueryInsStaff.service()!");
		return cOutXmlDoc;
	}
	
	private void rollback() {
		cLogger.debug("Into NewQueryInsStaff.rollback()...");
		...
		cLogger.debug("Out NewQueryInsStaff.rollback()!");
	}
	/**
	 * @param mInXmlDoc
	 * @return cInXmlDoc
