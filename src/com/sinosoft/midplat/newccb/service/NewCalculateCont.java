...
public class NewCalculateCont extends ServiceImpl {
	public NewCalculateCont(Element pThisBusiConf) {
		super(pThisBusiConf);
	}
	...
	public Document service(Document pInXmlDoc) {
		...
		cLogger.info("Into NewCalculateCont.service()...");
		cInXmlDoc = pInXmlDoc;
...
//			new RuleParser().check(cInXmlDoc);
			...
			cOutXmlDoc = new CallWebsvcAtomSvc(AblifeCodeDef.SID_Bank_CalculateCont).call(cInXmlDoc);
			System.out.println("-----------------------------------------------");
...
//			tOutBodyEle.getChild(ProposalPrtNo).setText(mContPrtNo);
		...
		cLogger.info("Out NewCalculateCont.service()!");
		return cOutXmlDoc;
	}
	
	
	private void rollback() {
		cLogger.debug("Into NewCalculateCont.rollback()...");
		...
		cLogger.debug("Out NewCalculateCont.rollback()!");
	}
	/**
	 * @param mInXmlDoc
	 * @return cInXmlDoc
