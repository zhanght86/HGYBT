			...
			<Prnts>
				...
				<Prnt>
					<Value>
						...
						<xsl:value-of select="ContNo"/><xsl:text>　　　　　　　</xsl:text>保险合同成立及生效日：<xsl:value-of select="java:com.sinosoft.midplat.common.DateUtilZR.date8to11(Risk[RiskCode=MainRiskCode]/CValiDate)"/>
					</Value>
				</Prnt>
				<Prnt>
					<Value>
						...
						<xsl:if test="count(Bnf) = 1">
							<xsl:for-each select="Bnf">
								...
								<xsl:if test=" $Type = 1 ">
									...
									<xsl:text/>
									<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_(java:com.sinosoft.midplat.common.DateUtilZR.AddBnfLot(Lot), 50)"/>
								</xsl:if>
							</xsl:for-each>
						</xsl:if>
						<xsl:if test="count(Bnf) = 2">
							<xsl:for-each select="Bnf">
								...
								<xsl:if test=" $Type = 1 ">
									...
									<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_(Name, 10)"/>
									<xsl:text/>
									<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_(java:com.sinosoft.midplat.common.DateUtilZR.AddBnfLot(Lot), 20)"/>
								</xsl:if>
							</xsl:for-each>
						</xsl:if>
				...
				<Prnt>
					<Value>
						...
						<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_(Risk[RiskCode=MainRiskCode]/RiskName, 84)"/>
					</Value>
				</Prnt>
				<Prnt>
					<Value>
				...
				<Prnt>
					<Value>
						<xsl:text>　　　　</xsl:text>
						<xsl:text/>
						<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_('主要保险利益摘要', 47)"/>
						<xsl:text/><xsl:text> | </xsl:text>
						<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_('现金价值及交清保额', 44)"/>
					</Value>
				</Prnt>
				<Prnt><Value><xsl:text>　　　　</xsl:text>--------------------------------------------------------------------------------------</Value></Prnt>
				<Prnt>
					<Value>
						...
						<xsl:text/>
						<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_('意外身故', 11)"/>
						<xsl:text/>
						<xsl:text> | </xsl:text>
				...
				<Prnt>
					<Value>
						<xsl:text>　　　　</xsl:text>
						<xsl:text>　　　　董事长：</xsl:text>
						<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_('签单机构：', 36 , $Falseflag)"/>
						<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_(ComName, 44 )"/>
					</Value>
				</Prnt>
				<Prnt>
					<Value/>
				...
				<Prnt>
					<Value>
						<xsl:text>        </xsl:text>
						<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_('敬告投保人', 96 )"/>
					</Value>
				</Prnt>
				<Prnt>
					<Value>
						<xsl:text>　　　　</xsl:text>
						<xsl:text/>
						<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_('', 4)"/>
						<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_('感谢您购买本公司通过代理银行或邮局销售的人寿保险！本保险单为我公司同意承', 92 )"/>
					</Value>
				</Prnt>
				<Prnt>
					<Value>
						<xsl:text>　　　　</xsl:text>
						<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_('保的凭证，为维护您的权益，请认真阅读，核对本保险单的各项内容，如核对无误，请在', 96 )"/>
					</Value>
				</Prnt>
				<Prnt>
					<Value>
						<xsl:text>　　　　</xsl:text>
						<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_('收据回执联上签收。', 96 )"/>
					</Value>
				</Prnt>
				<Prnt>
					<Value/>
