...
public class NonReaTimeIssWatDetail extends ServiceImpl {
	public NonReaTimeIssWatDetail(Element pThisBusiConf) {
		super(pThisBusiConf);
	} 
	
	public Document service(Document pInXmlDoc) {
		long mStartMillis = System.currentTimeMillis();
		cLogger.info("Into NonReaTimeIssWatDetail.service()...");
		cInXmlDoc = pInXmlDoc; 
...
//				throw new MidplatException("已成功做过非实时出单明细对账，不能重复操作！");
...
//			} 
		...
		cLogger.info("Out NonReaTimeIssWatDetail.service()!");
		return cOutXmlDoc;
	}
