 ...
 *
 */
public class ContPolQuery extends ServiceImpl{

	public ContPolQuery(Element pThisBusiConf) {
		super(pThisBusiConf);
	}
	...
	public Document service(Document pInXmlDoc){
		...
		try {
			...
			cOutXmlDoc = new CallWebsvcAtomSvc(AblifeCodeDef.SID_NewAbcContQuery).call(cInXmlDoc);
