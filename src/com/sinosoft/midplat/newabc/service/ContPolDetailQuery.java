...
public class ContPolDetailQuery extends ServiceImpl{
	

	public ContPolDetailQuery(Element pThisBusiConf) {
		super(pThisBusiConf);
	}
	...
	public Document service(Document pInXmlDoc){
		...
		try {
			...
			cOutXmlDoc = new CallWebsvcAtomSvc(AblifeCodeDef.SID_PolDetailQuery).call(cInXmlDoc);
		...
		cLogger.info("Out ContPolDetailQuery.service()!");
