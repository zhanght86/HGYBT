...
public class SecuTradAppDoc extends ServiceImpl {
	public SecuTradAppDoc(Element pThisBusiConf) {
		super(pThisBusiConf);
	} 
	
	public Document service(Document pInXmlDoc) {
		long mStartMillis = System.currentTimeMillis();
		cLogger.info("Into SecuTradAppDoc.service()...");
		cInXmlDoc = pInXmlDoc; 
...
//			} 
		...
		cLogger.info("Out SecuTradAppDoc.service()!");
		return cOutXmlDoc;
	}
