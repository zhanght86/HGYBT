...
public class NonReaTimeIssResDocBankDeal_2 extends ServiceImpl {
	public NonReaTimeIssResDocBankDeal_2(Element pThisBusiConf) {
		super(pThisBusiConf);
	} 
...
//			saveDetails(cInXmlDoc);
			...
			cOutXmlDoc = new CallWebsvcAtomSvc(AblifeCodeDef.SID_NonRealTimeContBankRst).call(cInXmlDoc);
