...
public class SurRetrDataDoc extends ServiceImpl {
	public SurRetrDataDoc(Element pThisBusiConf) {
		super(pThisBusiConf);
	} 
	
	public Document service(Document pInXmlDoc) {
		long mStartMillis = System.currentTimeMillis();
		cLogger.info("Into SurRetrDataDoc.service()...");
		cInXmlDoc = pInXmlDoc; 
	   JdomUtil.print(cInXmlDoc);
		...
		cLogger.info("Out SurRetrDataDoc.service()!");
		return cOutXmlDoc;
	}
	...
	protected ContBlcDtlSet saveDetails(Document pXmlDoc) throws Exception {
		cLogger.debug("Into SurRetrDataDoc.saveDetails()...");
	...
	//	long mSumPrem = Long.parseLong(mBodyEle.getChildText(Prem));
		...
		cLogger.debug("Out SurRetrDataDoc.saveDetails()!");
