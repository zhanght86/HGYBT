 ...
 *
 */
public class NewContQuery extends ServiceImpl{
	...
	public Document service(Document pInXmlDoc){
		...
		cLogger.info("Into NewContQuery.service()...");
		cInXmlDoc = pInXmlDoc;
...
//			}
			...
			cOutXmlDoc = new CallWebsvcAtomSvc(AblifeCodeDef.SID_NewContQuery).call(cInXmlDoc);
