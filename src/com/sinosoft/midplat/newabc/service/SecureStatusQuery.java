 ...
 * 
 */
public class SecureStatusQuery extends ServiceImpl{
	...
	public Document service(Document pInXmlDoc){
		...
		cLogger.info("Into SecureStatusQuery.service()...");
		cInXmlDoc = pInXmlDoc;
		...
		try {
			...
			cOutXmlDoc = new CallWebsvcAtomSvc(AblifeCodeDef.SID_SecureStatusQuery).call(cInXmlDoc);
		...
		cLogger.info("Out SecureStatusQuery.service()!");
