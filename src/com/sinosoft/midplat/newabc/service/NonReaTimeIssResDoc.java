 ...
 *
 */
public class NonReaTimeIssResDoc extends ServiceImpl {
	public NonReaTimeIssResDoc(Element pThisBusiConf) {
		super(pThisBusiConf);
	} 
	
	public Document service(Document pInXmlDoc) {
		long mStartMillis = System.currentTimeMillis();
		cLogger.info("Into NonReaTimeIssResDoc.service()...");
		cInXmlDoc = pInXmlDoc; 
	   JdomUtil.print(cInXmlDoc);
		...
		cLogger.info("Out NonReaTimeIssResDoc.service()!");
		return cOutXmlDoc;
	}
	...
	protected ContBlcDtlSet saveDetails(Document pXmlDoc) throws Exception {
		cLogger.debug("Into NonReaTimeIssResDoc.saveDetails()...");
	...
	//	long mSumPrem = Long.parseLong(mBodyEle.getChildText(Prem));
		...
		cLogger.debug("Out NonReaTimeIssResDoc.saveDetails()!");
