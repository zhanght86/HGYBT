...
public class NewInsPolRec extends ServiceImpl {
	public NewInsPolRec(Element pThisBusiConf) {
		super(pThisBusiConf);
	} 
	
	public Document service(Document pInXmlDoc) {
		long mStartMillis = System.currentTimeMillis();
		cLogger.info("Into NewInsPolRec.service()...");
		cInXmlDoc = pInXmlDoc; 
...
//			} 
		...
		cLogger.info("Out NewInsPolRec.service()!");
		return cOutXmlDoc;
	}
