...
public class NewAbcConf extends XmlConf {
	private static final NewAbcConf cThisIns = new NewAbcConf();
	
	private static final String cPath = "conf/newabc.xml";
	...
	public void load() {
		cLogger.info("Into NewAbcConf.load()...");
		...
		cLogger.info("Out NewAbcConf.load()!");
	}
	
	public static NewAbcConf newInstance() {
		return cThisIns;
	}
}
