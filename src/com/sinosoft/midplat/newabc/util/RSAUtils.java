...
public class RSAUtils {
	 ...
	 * @throws Exception
	 */
	public  static String readCRT_publicKey(String ctFileName) throws Exception{	
		    String publicKeyPath = SysInfo.cHome+"key/"+ctFileName;
	...
	public static String createAESCode(){
		System.out.println("开始生成AES工作密钥...");
   ...
   public static void main(String[] args) throws Exception{
	   System.out.println(RSAUtils.readCRT_publicKey("cacert.crt"));
}
}
