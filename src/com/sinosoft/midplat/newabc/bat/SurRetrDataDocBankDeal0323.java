 ...
 *
 */
public class SurRetrDataDocBankDeal0323 extends Balance{
	public SurRetrDataDocBankDeal0323() {
...
//			tAgentCom.setText(nodeNo);
			...
			if("2".equals(tSubMsgs[11])){//受理状态成功
				tHandleState.setText("0");
			}
			if("3".equals(tSubMsgs[11])){
...
//			tDetailEle.addContent(tProposalPrtNoEle);
	...
	public static void main(String[] args) throws Exception {
		...
		SurRetrDataDocBankDeal0323 mBatch = new SurRetrDataDocBankDeal0323();
		//用于补对账，设置补对账日期
		if (0 != args.length) {
