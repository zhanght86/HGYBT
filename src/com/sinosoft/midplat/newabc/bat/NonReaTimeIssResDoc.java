 ...
 *
 */
public class NonReaTimeIssResDoc extends ToBankBalance{
	public NonReaTimeIssResDoc() {
		super(NewAbcConf.newInstance(), "2005");
	}
	protected String getFileName() {
		...
		String fileName="FRESULT"+mBankEle.getAttributeValue("insu")+"."+DateUtil.getDateStr(cTranDate, "yyyyMMdd");
		try {
			f.bank_dz_file();
		} catch (Exception ex) {
			ex.printStackTrace();
	...
	protected Element parse(InputStream pBatIs) throws Exception {
		cLogger.info("Into NonReaTimeIssResDoc.parse()...");
...
//			tProposalPrtNoEle.setText(tSubMsgs[11]);
			...
			long tPremFen = NumberUtil.yuanToFen(tSubMsgs[13]);
...
//			tDetailEle.addContent(tProposalPrtNoEle);
		...
		cLogger.info("Out NonReaTimeIssResDoc.parse()!");
		return mBodyEle;
	}
	
	protected Element getHead() {
		cLogger.info("Into NonReaTimeIssResDoc.getHead()...");
		...
		cLogger.info("Out NonReaTimeIssResDoc.getHead()!");
		return mHead;
	}
	
	
	public static void main(String[] args) throws Exception {
		Logger mLogger = Logger.getLogger("com.sinosoft.midplat.Abc.bat.NonReaTimeIssResDoc.main");
		mLogger.info("程序开始...");
