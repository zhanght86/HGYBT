...
public class PolQueryOutXsl extends XslCache {
	private static PolQueryOutXsl cThisIns = new PolQueryOutXsl();
	
	private String cPath = "com/sinosoft/midplat/newabc/format/PolQueryOut.xsl";
	
	private PolQueryOutXsl() {
		load();
		FileCacheManage.newInstance().register(cPath, this);
	}
	
	public void load() {
		cLogger.info("Into PolQueryOutXsl.load()...");
		...
		cLogger.info("Out PolQueryOutXsl.load()!");
	}
	
	public static PolQueryOutXsl newInstance() {
		return cThisIns;
	}
}