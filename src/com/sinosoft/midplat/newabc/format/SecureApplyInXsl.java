...
public class SecureApplyInXsl extends XslCache {
	private static SecureApplyInXsl cThisIns = new SecureApplyInXsl();
	
	private String cPath = "com/sinosoft/midplat/newabc/format/SecureApplyIn.xsl";
	
	private SecureApplyInXsl() {
		load();
		FileCacheManage.newInstance().register(cPath, this);
	}
	
	public void load() {
		cLogger.info("Into SecureApplyInXsl.load()...");
		...
		cLogger.info("Out SecureApplyInXsl.load()!");
	}
	
	public static SecureApplyInXsl newInstance() {
		return cThisIns;
	}
}