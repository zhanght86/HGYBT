...
public class SecureQueryInXsl extends XslCache {
	private static SecureQueryInXsl cThisIns = new SecureQueryInXsl();
	
	private String cPath = "com/sinosoft/midplat/newabc/format/SecureQueryIn.xsl";
	
	private SecureQueryInXsl() {
		load();
		FileCacheManage.newInstance().register(cPath, this);
	}
	
	public void load() {
		cLogger.info("Into SecureQueryInXsl.load()...");
		...
		cLogger.info("Out SecureQueryInXsl.load()!");
	}
	
	public static SecureQueryInXsl newInstance() {
		return cThisIns;
	}
}