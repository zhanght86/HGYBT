...
public class PolQueryInXsl extends XslCache {
	private static PolQueryInXsl cThisIns = new PolQueryInXsl();
	
	private String cPath = "com/sinosoft/midplat/newabc/format/PolQueryIn.xsl";
	
	private PolQueryInXsl() {
		load();
		FileCacheManage.newInstance().register(cPath, this);
	}
	
	public void load() {
		cLogger.info("Into PolQueryInXsl.load()...");
		...
		cLogger.info("Out PolQueryInXsl.load()!");
	}
	
	public static PolQueryInXsl newInstance() {
		return cThisIns;
	}
}