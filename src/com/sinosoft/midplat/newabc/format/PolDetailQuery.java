...
public class PolDetailQuery extends XmlSimpFormat {
		...
		public Document noStd2Std(Document pNoStdXml) throws Exception {
			...
			Document mStdXml = PolDetailQueryInXsl.newInstance().getCache().transform(pNoStdXml);
			//测试
		...
		public Document std2NoStd(Document pStdXml) throws Exception {
			...
			Document mNoStdXml = PolDetailQueryOutXsl.newInstance().getCache().transform(pStdXml);
	...
	public static void main(String[] args)  throws Exception  {
		...
		String mInFilePath = "D:/File/task/20170605/newabc/transfer_test/1021out_Std.xml";
		String mOutFilePath = "D:/File/task/20170605/newabc/transfer_test/1021out_noStd.xml";
