...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:java="http://xml.apache.org/xslt/java" exclude-result-prefixes="java">
	...
	<xsl:template name="Base" match="Body">
			...
			<Prnts>
				...
				<Prnt/> 
				   ...
				   <Prnt><xsl:text>　　　 </xsl:text><xsl:text>被保人姓名：</xsl:text><xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_(Insured/Name, 18)"/>
					...
					<Prnt><xsl:text>　 </xsl:text>    受益人姓名：<xsl:value-of select="java:com.sinosoft.midplat.common.NumberUtil.fillStrWith_(Name, 13)"/>																
		...
		<TbdPrnts>
						   ...
						   <Prnt><xsl:text>　     </xsl:text><xsl:text>保险条款等相关资料，经审核确认保险合同内容正确无误。本人已阅读过保险条款、投保提示书和产品</xsl:text></Prnt>
						   <Prnt><xsl:text>　     </xsl:text><xsl:text>说明书，确认已了解并认可保险合同的全部内容，知晓本人的权利和义务。</xsl:text></Prnt>
