...
public class BusiBlcInXsl extends XslCache {
	private static BusiBlcInXsl cThisIns = new BusiBlcInXsl();
	
	private String cPath = "com/sinosoft/midplat/srcb/format/BusiBlcIn.xsl";
	
	private BusiBlcInXsl() {
		load();
		FileCacheManage.newInstance().register(cPath, this);
	}
	
	public void load() {
		cLogger.info("Into BusiBlcInXsl.load()...");
		...
		cLogger.info("Out BusiBlcInXsl.load()!");
	}
	
	public static BusiBlcInXsl newInstance() {
		return cThisIns;
	}
}