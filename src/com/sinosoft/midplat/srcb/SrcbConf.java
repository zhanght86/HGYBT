package com.sinosoft.midplat.srcb;
...
public class SrcbConf extends XmlConf {
	private static SrcbConf cThisIns = new SrcbConf();
	
	private String cPath = "conf/srcb.xml";
	...
	public void load() {
		cLogger.info("Into SrcbConf.load()...");
		...
		cLogger.info("Out SrcbConf.load()!");
	}
	
	public static SrcbConf newInstance() {
		return cThisIns;
	}
}
