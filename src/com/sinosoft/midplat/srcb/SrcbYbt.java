...
public class SrcbYbt extends Ybt4Socket {
	public SrcbYbt(Socket pSocket) throws Exception {
		super(pSocket, SrcbConf.newInstance());
	}
	
	protected Document getErrorXml(String pErrorMsg) {
		cLogger.info("Into SrcbYbt.getErrorXml()...");
		...
		cLogger.info("Out SrcbYbt.getErrorXml()!");
