...
public class PSBCFileTransCmd {
	...
	/**
	 * @param vs_outsys_code
	 *            the vs_outsys_code to set
	 */
	...
	/**
	 * @param vs_send_recv_flag
	 *            the vs_send_recv_flag to set
	 */
	...
	/**
	 * @param vs_local_file_dir
	 *            the vs_local_file_dir to set
	 */
	...
	/**
	 * @param vs_local_file_name
	 *            the vs_local_file_name to set
	 */
	...
	/**
	 * @param vs_remote_file_dir
	 *            the vs_remote_file_dir to set
	 */
	...
	/**
	 * @param vs_remote_file_name
	 *            the vs_remote_file_name to set
	 */
	...
	/**
	 * @param vl_file_start_positon
	 *            the vl_file_start_positon to set
	 */
	...
	public void displayFileCmd() {
		System.out.println("FileCmd:" + vs_outsys_code);
		System.out.println("FileCmd:" + vs_req_flag);
		System.out.println("FileCmd:" + vs_send_recv_flag);
		System.out.println("FileCmd:" + vs_local_file_dir);
		System.out.println("FileCmd:" + vs_local_file_name);
		System.out.println("FileCmd:" + vs_remote_file_dir);
		System.out.println("FileCmd:" + vs_remote_file_name);
		System.out.println("FileCmd:" + vl_file_size);
		System.out.println("FileCmd:" + vl_file_start_positon);
		System.out.println("FileCmd:" + vl_trans_size);
		System.out.println("FileCmd:" + vs_retcode);
	}
