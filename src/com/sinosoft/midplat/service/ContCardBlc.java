...
public class ContCardBlc extends ServiceImpl {
	public ContCardBlc(Element pThisBusiConf) {
		super(pThisBusiConf);
	}
	
	public Document service(Document pInXmlDoc) {
		long mStartMillis = System.currentTimeMillis();
		cLogger.info("Into ContCardBlc.service()...");
		cInXmlDoc = pInXmlDoc;
		...
		cLogger.info("Out ContCardBlc.service()!");
		return cOutXmlDoc;
	}
}
