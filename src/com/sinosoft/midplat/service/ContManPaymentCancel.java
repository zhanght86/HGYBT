...
public class ContManPaymentCancel extends ServiceImpl{
	public ContManPaymentCancel(Element pThisBusiConf) {
		super(pThisBusiConf);
	}
	
	public Document service(Document pInXmlDoc) {
		long mStartMillis = System.currentTimeMillis();
		cLogger.info("Into ContManPaymentCancel.service()...");
		cInXmlDoc = pInXmlDoc;
		...
		try {
			...
			cLogger.info("Into ContManPaymentCancel.service()...-->authorityCheck.submitData(mHeadEle)交易权限");	
...
//			cOutXmlDoc = new CallWebsvcAtomSvc(AblifeCodeDef.SID_Bank_ManPaymentCancel).call(cInXmlDoc);
...
//			假交易，返回成功
		...
		cLogger.info("Out ContManPaymentCancel.service()!");
		return cOutXmlDoc;
	}
	/**
	 * @param mInXmlDoc
