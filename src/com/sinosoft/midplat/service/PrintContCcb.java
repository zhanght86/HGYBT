...
public class PrintContCcb extends ServiceImpl {
	public PrintContCcb(Element pThisBusiConf) {
		super(pThisBusiConf);
	}
	...
	public Document service(Document pInXmlDoc) {
		...
		cLogger.info("Into PrintContCcb.service()...");
		cInXmlDoc = pInXmlDoc;
		...
		cLogger.info("Out PrintContCcb.service()!");
		return cOutXmlDoc;
	}
