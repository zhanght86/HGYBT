...
public class ICBCNewContInput extends ServiceImpl {
	public ICBCNewContInput(Element pThisBusiConf) {
		super(pThisBusiConf);
	}
...
//			cInXmlDoc = authority(cInXmlDoc); 	
			...
			//处理非柜台创赢财富错误提示
			if(!"0".equals(mSaleChannel)&&"0".equals(mMult)&&"241201".equals(mRiskCode)){
				throw new MidplatException("创赢财富产品投保份数需大于0！");
			} 
			...
			if("211901".equals(tRiskCode.getTextTrim())){//农行的借贷险用这种更细化的校验方式
			...
			cOutXmlDoc = new CallWebsvcAtomSvc("25").call(cInXmlDoc);
