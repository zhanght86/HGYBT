...
public class ContCancelCcb extends ServiceImpl {
	public ContCancelCcb(Element pThisBusiConf) {
		super(pThisBusiConf);
	}
	
	public Document service(Document pInXmlDoc) {
		long mStartMillis = System.currentTimeMillis();
		cLogger.info("Into ContCancelCcb.service()...");
		cInXmlDoc = pInXmlDoc;
	//	JdomUtil.print(cInXmlDoc);
		...
		String sql = "select otherno from tranlog where tranno = '"+mTransNo+"' and trandate = '"+mTranDate+"' and trancom = '"+mTranCom+"' ";
		ExeSQL dExeSQL = new ExeSQL();
		String motherno = dExeSQL.getOneValue(sql);
		...
		try { 
			...
			cLogger.info("Into ContCancelCcb.service()...-->authorityCheck.submitData(mHeadEle)交易权限");	
...
//			}
		...
		cLogger.info("Out ContCancelCcb.service()!");
		return cOutXmlDoc;
	} 
