...
public class NewPrintAppCont extends ServiceImpl {
	public NewPrintAppCont(Element pThisBusiConf) {
		super(pThisBusiConf);
	}
	...
	public Document service(Document pInXmlDoc) {
		...
		cLogger.info("Into NewPrintAppCont.service()...");
		cInXmlDoc = pInXmlDoc;
...
//			cTranLogDB.setContNo(tContDB.getContNo());
		...
		cLogger.info("Out NewPrintAppCont.service()!");
		return cOutXmlDoc;
	}
	
	private ContDB getContDB() {
		cLogger.debug("Into NewPrintAppCont.getContDB()...");
...
//JdomUtil.print(cOutXmlDoc);
		...
		cLogger.debug("Out NewPrintAppCont.getContDB()!");
		return mContDB;
	}
	
	private void rollback() {
		cLogger.debug("Into NewPrintAppCont.rollback()...");
		...
		cLogger.debug("Out NewPrintAppCont.rollback()!");
	}
	/**
	 * @param mInXmlDoc
	 * @return cInXmlDoc
