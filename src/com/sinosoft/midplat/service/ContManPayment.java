...
public class ContManPayment extends ServiceImpl{
	public ContManPayment(Element pThisBusiConf) {
		super(pThisBusiConf);
	}
	
	public Document service(Document pInXmlDoc) {
		long mStartMillis = System.currentTimeMillis();
		cLogger.info("Into ContManPayment.service()...");
		cInXmlDoc = pInXmlDoc;
		...
		try {
			...
			cLogger.info("Into ContManPayment.service()...-->authorityCheck.submitData(mHeadEle)交易权限");	
...
//			}
		...
		cLogger.info("Out ContManPayment.service()!");
		return cOutXmlDoc;
	}
	/**
	 * @param mInXmlDoc
