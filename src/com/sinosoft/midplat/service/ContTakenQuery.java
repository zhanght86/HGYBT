...
public class ContTakenQuery extends ServiceImpl{

	public ContTakenQuery(Element pThisBusiConf) {
		super(pThisBusiConf);
	}
	
	public Document service(Document pInXmlDoc) {
		long mStartMillis = System.currentTimeMillis();
		cLogger.info("Into ContTakenQuery.service()...");
		cInXmlDoc = pInXmlDoc;
		...
		try {
			...
			//20140926 modify by lilu 退保查询去掉网点校验，邵宇洪确定的
//			cLogger.info("Into ContTakenQuery.service()...-->authorityCheck.submitData(mHeadEle)交易权限");	
...
//			} 
		...
		cLogger.info("Out ContTakenQuery.service()!");
		return cOutXmlDoc;
	}
	/**
	 * @param mInXmlDoc
