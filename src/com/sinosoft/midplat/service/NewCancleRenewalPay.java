...
public class NewCancleRenewalPay extends ServiceImpl {
	public NewCancleRenewalPay(Element pThisBusiConf) {
		super(pThisBusiConf);
	}
	...
	public Document service(Document pInXmlDoc) {
		...
		cLogger.info("Into NewCancleRenewalPay.service()...");
		cInXmlDoc = pInXmlDoc;
...
//			cInXmlDoc = authority(cInXmlDoc); 	
			...
			cOutXmlDoc = new CallWebsvcAtomSvc(AblifeCodeDef.SID_Bank_RenewPaymentCancel).call(cInXmlDoc);
			System.out.println("-----------------------------------------------");
...
//			cTranLogDB.setContNo(tContDB.getContNo());
		...
		cLogger.info("Out NewCancleRenewalPay.service()!");
		return cOutXmlDoc;
	}
	
	private ContDB getContDB() {
		cLogger.debug("Into NewCancleRenewalPay.getContDB()...");
...
//JdomUtil.print(cOutXmlDoc);
		...
		cLogger.debug("Out NewCancleRenewalPay.getContDB()!");
		return mContDB;
	}
	
	private void rollback() {
		cLogger.debug("Into NewCancleRenewalPay.rollback()...");
		...
		cLogger.debug("Out NewCancleRenewalPay.rollback()!");
	}
	/**
	 * @param mInXmlDoc
	 * @return cInXmlDoc
