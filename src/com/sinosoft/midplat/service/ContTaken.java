...
public class ContTaken extends ServiceImpl{

	public ContTaken(Element pThisBusiConf) {
		super(pThisBusiConf);
	}
	public Document service(Document pInXmlDoc) {
		long mStartMillis = System.currentTimeMillis();
		cLogger.info("Into ContTaken.service()...");
		cInXmlDoc = pInXmlDoc;
		...
		try {
			...
			cLogger.info("Into ContTaken.service()...-->authorityCheck.submitData(mHeadEle)交易权限");	
		...
		cLogger.info("Out ContTaken.service()!");
		return cOutXmlDoc;
	}
	/**
	 * @param mInXmlDoc
