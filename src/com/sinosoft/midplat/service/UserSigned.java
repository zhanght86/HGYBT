...
public class UserSigned extends ServiceImpl {
	...
	public Document service(Document pInXmlDoc) {
		...
		cLogger.info("Into UserSigned.service()...");
		cInXmlDoc = pInXmlDoc;
...
//			cOutXmlDoc=new Document(iTranData);
			...
			Element tBankAccNo= new Element("BankAccNo");
			tBankAccNo.setText(mBankAccNo);
			...
			tBodyEle.addContent(tBankAccNo);
		...
		cLogger.info("Out UserSigned.service()!");
		return cOutXmlDoc;
	}
}
