...
public class NewQueryPrem extends ServiceImpl {
	public NewQueryPrem(Element pThisBusiConf) {
		super(pThisBusiConf);
	}
	...
	public Document service(Document pInXmlDoc) {
		...
		cLogger.info("Into NewQueryPrem.service()...");
		cInXmlDoc = pInXmlDoc;
...
//			cInXmlDoc = authority(cInXmlDoc); 	
			...
			cOutXmlDoc = new CallWebsvcAtomSvc(AblifeCodeDef.SID_Bank_RenewPaymentQuery).call(cInXmlDoc);
			System.out.println("-----------------------------------------------");
...
//			cTranLogDB.setContNo(tContDB.getContNo());
		...
		cLogger.info("Out NewQueryPrem.service()!");
		return cOutXmlDoc;
	}
	
	private ContDB getContDB() {
		cLogger.debug("Into NewQueryPrem.getContDB()...");
...
//JdomUtil.print(cOutXmlDoc);
		...
		cLogger.debug("Out NewQueryPrem.getContDB()!");
		return mContDB;
	}
	
	private void rollback() {
		cLogger.debug("Into NewQueryPrem.rollback()...");
		...
		cLogger.debug("Out NewQueryPrem.rollback()!");
	}
	/**
	 * @param mInXmlDoc
	 * @return cInXmlDoc
