...
public class NewExpirationPay extends ServiceImpl {
	public NewExpirationPay(Element pThisBusiConf) {
		super(pThisBusiConf);
	}
	...
	public Document service(Document pInXmlDoc) {
		...
		cLogger.info("Into NewExpirationPay.service()...");
		cInXmlDoc = pInXmlDoc;
...
//			cTranLogDB.setContNo(tContDB.getContNo());
		...
		cLogger.info("Out NewExpirationPay.service()!");
		return cOutXmlDoc;
	}
	
	private ContDB getContDB() {
		cLogger.debug("Into NewExpirationPay.getContDB()...");
...
//JdomUtil.print(cOutXmlDoc);
		...
		cLogger.debug("Out NewExpirationPay.getContDB()!");
		return mContDB;
	}
	
	private void rollback() {
		cLogger.debug("Into NewExpirationPay.rollback()...");
		...
		cLogger.debug("Out NewExpirationPay.rollback()!");
	}
	/**
	 * @param mInXmlDoc
	 * @return cInXmlDoc
