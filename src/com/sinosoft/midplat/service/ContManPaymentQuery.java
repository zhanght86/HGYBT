...
public class ContManPaymentQuery extends ServiceImpl{

	public ContManPaymentQuery(Element pThisBusiConf) {
		super(pThisBusiConf);
	}
	public Document service(Document pInXmlDoc) {
		long mStartMillis = System.currentTimeMillis();
		cLogger.info("Into ContManPaymentQuery.service()...");
		cInXmlDoc = pInXmlDoc;
		...
		try {
			...
			cLogger.info("Into ContManPaymentQuery.service()...-->authorityCheck.submitData(mHeadEle)交易权限");	
		...
		cLogger.info("Out ContManPaymentQuery.service()!");
		return cOutXmlDoc;
	}
	/**
	 * @param mInXmlDoc
