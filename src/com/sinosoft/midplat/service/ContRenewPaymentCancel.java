...
public class ContRenewPaymentCancel extends ServiceImpl{

	public ContRenewPaymentCancel(Element pThisBusiConf) {
		super(pThisBusiConf);
	}
	public Document service(Document pInXmlDoc) {
		long mStartMillis = System.currentTimeMillis();
		cLogger.info("Into ContRenewPaymentCancel.service()...");
		cInXmlDoc = pInXmlDoc;
		...
		try {
			...
			cLogger.info("Into ContRenewPaymentCancel.service()...-->authorityCheck.submitData(mHeadEle)交易权限");	
...
//			假交易，返回成功
		...
		cLogger.info("Out ContRenewPaymentCancel.service()!");
		return cOutXmlDoc;
	}
	/**
	 * @param mInXmlDoc
