...
public class NewQueryExpirationPay extends ServiceImpl {
	public NewQueryExpirationPay(Element pThisBusiConf) {
		super(pThisBusiConf);
	}
	...
	public Document service(Document pInXmlDoc) {
		...
		cLogger.info("Into NewQueryExpirationPay.service()...");
		cInXmlDoc = pInXmlDoc;
...
//			cTranLogDB.setContNo(tContDB.getContNo());
		...
		cLogger.info("Out NewQueryExpirationPay.service()!");
		return cOutXmlDoc;
	}
	
	private ContDB getContDB() {
		cLogger.debug("Into NewQueryExpirationPay.getContDB()...");
...
//JdomUtil.print(cOutXmlDoc);
		...
		cLogger.debug("Out NewQueryExpirationPay.getContDB()!");
		return mContDB;
	}
	
	private void rollback() {
		cLogger.debug("Into NewQueryExpirationPay.rollback()...");
		...
		cLogger.debug("Out NewQueryExpirationPay.rollback()!");
	}
	/**
	 * @param mInXmlDoc
	 * @return cInXmlDoc
