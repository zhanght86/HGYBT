...
public class ContQuery extends ServiceImpl {
	...
	public Document service(Document pInXmlDoc) {
		...
		cLogger.info("Into ContQuery.service()...");
		cInXmlDoc = pInXmlDoc;
		...
		try {
			...
			cLogger.info("Into ContQuery.service()...-->authorityCheck.submitData(mHeadEle)交易权限");	
			...
			cOutXmlDoc = new CallWebsvcAtomSvc(AblifeCodeDef.SID_Bank_ContQuery).call(cInXmlDoc);
		...
		cLogger.info("Out ContQuery.service()!");
		return cOutXmlDoc;
	}
	/**
	 * @param mInXmlDoc
