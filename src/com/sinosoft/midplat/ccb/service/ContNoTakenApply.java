...
public class ContNoTakenApply extends ServiceImpl{

	public ContNoTakenApply(Element pThisBusiConf) {
		super(pThisBusiConf);
	}
	
	public Document service(Document pInXmlDoc){
		long mStartMills = System.currentTimeMillis();
		cLogger.info("Into ContNoTakenApply.service()........");
		cInXmlDoc = pInXmlDoc;
		...
		try {
			...
			cLogger.info("Into ContNoTakenApply.service()...-->authorityCheck.submitData(mHeadEle)交易权限");	
			...
			cOutXmlDoc = new CallWebsvcAtomSvc(AblifeCodeDef.SID_Bank_NoTakenQuery).call(pInXmlDoc);
		...
		cLogger.info("Out ContNoTakenApply.service()........");
		return cOutXmlDoc;
	}
