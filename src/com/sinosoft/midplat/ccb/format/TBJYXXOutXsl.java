...
public class TBJYXXOutXsl extends XslCache {
	private static TBJYXXOutXsl cThisIns = new TBJYXXOutXsl();
	
	private String cPath = "com/sinosoft/midplat/ccb/format/TBJYXXOut.xsl";
	
	private TBJYXXOutXsl() {
		load();
		FileCacheManage.newInstance().register(cPath, this);
	}
	
	public void load() {
		cLogger.info("Into TBJYXXOutXsl.load()...");
		...
		cLogger.info("Out TBJYXXOutXsl.load()!");
	}
	
	public static TBJYXXOutXsl newInstance() {
		return cThisIns;
	}
}
