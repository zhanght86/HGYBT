...
<!-- 转换险种代码 -->
	<xsl:template name="tran_RiskCode">
		...
		<xsl:if test="$RiskCode = 231201">0001</xsl:if>
		<xsl:if test="$RiskCode = 231202">0002</xsl:if>
		<xsl:if test="$RiskCode = 231203">0003</xsl:if>
		<xsl:if test="$RiskCode = 221201">0004</xsl:if><!-- 中韩保驾护航两全保险A款 -->
		<xsl:if test="$RiskCode = 231204">0005</xsl:if><!-- 中韩智赢财富两全保险（分红型）C款 -->
		<xsl:if test="$RiskCode = 221301">0006</xsl:if><!-- 中韩智赢财富两全保险（分红型）C款 -->
