...
public class TBJYXXInXsl extends XslCache {
	private static TBJYXXInXsl cThisIns = new TBJYXXInXsl();
	
	private String cPath = "com/sinosoft/midplat/ccb/format/TBJYXXIn.xsl";
	...
	public void load() {
		cLogger.info("Into TBJYXXInXsl.load()...");
		...
		cLogger.info("Out TBJYXXInXsl.load()!");
	}
	
	public static TBJYXXInXsl newInstance() {
		return cThisIns;
	}
}