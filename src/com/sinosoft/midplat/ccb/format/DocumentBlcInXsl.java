...
public class DocumentBlcInXsl extends XslCache {
	private static DocumentBlcInXsl cThisIns = new DocumentBlcInXsl();
	
	private String cPath = "com/sinosoft/midplat/ccb/format/DocumentBlcIn.xsl";
	
	private DocumentBlcInXsl() {
		load();
		FileCacheManage.newInstance().register(cPath, this);
	}
	
	public void load() {
		cLogger.info("Into DocumentBlcInXsl.load()...");
		...
		cLogger.info("Out DocumentBlcInXsl.load()!");
	}
	
	public static DocumentBlcInXsl newInstance() {
		return cThisIns;
	}
}