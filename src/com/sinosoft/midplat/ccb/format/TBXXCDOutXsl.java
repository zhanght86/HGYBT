...
public class TBXXCDOutXsl extends XslCache {
	private static TBXXCDOutXsl cThisIns = new TBXXCDOutXsl();
	
	private String cPath = "com/sinosoft/midplat/ccb/format/TBXXCDOut.xsl";
	
	private TBXXCDOutXsl() {
		load();
		FileCacheManage.newInstance().register(cPath, this);
	}
	
	public void load() {
		cLogger.info("Into TBXXCDOutXsl.load()...");
		...
		cLogger.info("Out TBXXCDOutXsl.load()!");
	}
	
	public static TBXXCDOutXsl newInstance() {
		return cThisIns;
	}
}
