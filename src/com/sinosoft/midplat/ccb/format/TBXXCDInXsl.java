...
public class TBXXCDInXsl extends XslCache {
	private static TBXXCDInXsl cThisIns = new TBXXCDInXsl();
	
	private String cPath = "com/sinosoft/midplat/ccb/format/TBXXCDIn.xsl";
	...
	public void load() {
		cLogger.info("Into TBXXCDInXsl.load()...");
		...
		cLogger.info("Out TBXXCDInXsl.load()!");
	}
	
	public static TBXXCDInXsl newInstance() {
		return cThisIns;
	}
}