 ...
 *
 */
public class PolicyCancelConfirm extends XmlSimpFormat {
	...
	String TranCode;//交易码
	public PolicyCancelConfirm(Element pThisConf) {
		super(pThisConf);
	}
	public Document noStd2Std(Document pNoStdXml) throws Exception {
		...
		Document mStdXml = PolicyCancelConfirmInXsl.newInstance().getCache().transform(pNoStdXml);
	...
	public Document std2NoStd(Document pStdXml) throws Exception {
		...
		Document mNoStdXml = PolicyCancelConfirmOutXsl.newInstance().getCache().transform(pStdXml);
