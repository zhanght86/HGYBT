...
public class PolicyCancelConfirmOutXsl extends XslCache {
	private static PolicyCancelConfirmOutXsl cThisIns = new PolicyCancelConfirmOutXsl();
	
	private String cPath = "com/sinosoft/midplat/boc/format/PolicyCancelConfirmOut.xsl";
	
	private PolicyCancelConfirmOutXsl() {
		load();
	...
	public static PolicyCancelConfirmOutXsl newInstance() {
		return cThisIns;
	}
}