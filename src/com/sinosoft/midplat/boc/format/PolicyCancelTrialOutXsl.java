...
public class PolicyCancelTrialOutXsl extends XslCache {
	private static PolicyCancelTrialOutXsl cThisIns = new PolicyCancelTrialOutXsl();
	
	private String cPath = "com/sinosoft/midplat/boc/format/PolicyCancelTrialOut.xsl";
	
	private PolicyCancelTrialOutXsl() {
		load();
	...
	public static PolicyCancelTrialOutXsl newInstance() {
		return cThisIns;
	}
}