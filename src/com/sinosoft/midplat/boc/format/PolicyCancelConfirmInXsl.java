...
public class PolicyCancelConfirmInXsl extends XslCache {
	private static PolicyCancelConfirmInXsl cThisIns = new PolicyCancelConfirmInXsl();
	
	private String cPath = "com/sinosoft/midplat/boc/format/PolicyCancelConfirmIn.xsl";
	
	private PolicyCancelConfirmInXsl() {
		load();
	...
	public static PolicyCancelConfirmInXsl newInstance() {
		return cThisIns;
	}
}
