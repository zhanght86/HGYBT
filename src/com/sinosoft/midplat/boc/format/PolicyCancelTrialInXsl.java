...
public class PolicyCancelTrialInXsl extends XslCache {
	private static PolicyCancelTrialInXsl cThisIns = new PolicyCancelTrialInXsl();
	
	private String cPath = "com/sinosoft/midplat/boc/format/PolicyCancelTrialIn.xsl";
	
	private PolicyCancelTrialInXsl() {
		load();
	...
	public static PolicyCancelTrialInXsl newInstance() {
		return cThisIns;
	}
}
