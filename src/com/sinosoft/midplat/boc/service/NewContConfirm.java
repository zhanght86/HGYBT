...
//			if("03".equals(mRootEle.getChild(Head).getChildText(TranCom))){//建行的交易
//				String getProposalPrtNoSQL = "select ProposalPrtNo from TranLog where TranDate = "+DateUtil.getCur8Date()
//								+" and TranNo = '"+mBodyEle.getChildText(OldTranNo)+"' and RCode=0 ";
//				
...
//				
//				//获取录单核保的保单印刷号
//				String getoldPrtNo = "select otherNo from TranLog where TranDate = "+DateUtil.getCur8Date()
//				+" and TranNo = '"+mBodyEle.getChildText(OldTranNo)+"' and RCode=0 ";
...
//				String tSqlStr = "select * from TranLog where ProposalPrtNo = '"+mProposalPrtNo+"' " +
...
//			//更新保单状态
			...
			tSqlStr = new StringBuilder("update Cont set State=").append(AblifeCodeDef.ContState_Sign)
				...
				.append(" where ProposalPrtNo=").append(tContSchema.getProposalPrtNo())
				.toString();
