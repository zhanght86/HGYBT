...
public class GZBankConf extends XmlConf {
	private static final GZBankConf cThisIns = new GZBankConf();
	
	private static final String cPath = "conf/gzbank.xml";
	...
	public void load() {
		cLogger.info("Into GZBankConf.load()...");
		...
		cLogger.info("Out GZBankConf.load()!");
	}
	
	public static GZBankConf newInstance() {
		return cThisIns;
	}
}
