...
public class JhyhConf extends XmlConf {
	private static JhyhConf cThisIns = new JhyhConf();
	
	private String cPath = "conf/jhyh.xml";
	...
	public void load() {
		cLogger.info("Into JhyhConf.load()...");
		...
		cLogger.info("Out JhyhConf.load()!");
	}
	
	public static JhyhConf newInstance() {
		return cThisIns;
	}
}
