...
public class ToIcbcProposalContState extends Balance {
	public ToIcbcProposalContState() {
		super(IcbcConf.newInstance(), "203");
	}
	protected String getFileName() {
		Element mBankEle = cThisConfRoot.getChild("bank");
		return "TOICBC"+mBankEle.getAttributeValue("insu")+mBankEle.getAttributeValue(id)+DateUtil.getDateStr(cTranDate, "yyyyMMdd")+"05.txt";
	}
	protected Element parse(InputStream pBatIs) throws Exception {
		cLogger.info("Into ToIcbcProposalContState.parse()...");
		...
		cLogger.info("Out ToIcbcProposalContState.parse()!");
		return mBodyEle;
	}
	
	public static void main(String[] args) throws Exception {
		Logger mLogger = Logger.getLogger("com.sinosoft.midplat.icbc.bat.ToIcbcProposalContState.main");
		mLogger.info("程序开始...");
		
		ToIcbcProposalContState mBatch = new ToIcbcProposalContState();
