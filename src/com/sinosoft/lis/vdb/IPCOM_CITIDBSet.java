...
public class IPCOM_CITIDBSet extends IPCOM_CITISet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public IPCOM_CITIDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean insert()
	{
		...
		for (int i = 1; i <= n; i++)
		{
			...
			aSchema.setSchema( (IPCOM_CITISchema)this.get(i) );
			if (db.insert(aSchema) == false)
			{
				// @@错误处理
				this.mErrors.copyAllErrors(db.mErrors);
				CError tError = new CError();
				tError.moduleName = "IPCOM_CITIDBSet";
