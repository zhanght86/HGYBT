/*
 * <p>ClassName: LMPublicCheckFieldDBSet </p>
...
public class LMPublicCheckFieldDBSet extends LMPublicCheckFieldSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LMPublicCheckFieldDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public LMPublicCheckFieldDBSet()
	{
	...
	public boolean insert()
	{
		...
		for (int i = 1; i <= n; i++)
		{
			...
			aSchema.setSchema( (LMPublicCheckFieldSchema)this.get(i) );
			if (db.insert(aSchema) == false)
			{
				// @@错误处理
				this.mErrors.copyAllErrors(db.mErrors);
				CError tError = new CError();
				tError.moduleName = "LMPublicCheckFieldDBSet";
