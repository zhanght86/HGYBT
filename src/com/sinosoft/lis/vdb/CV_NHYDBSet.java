...
public class CV_NHYDBSet extends CV_NHYSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public CV_NHYDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean insert()
	{
		...
		for (int i = 1; i <= n; i++)
		{
			...
			aSchema.setSchema( (CV_NHYSchema)this.get(i) );
			if (db.insert(aSchema) == false)
			{
				// @@错误处理
				this.mErrors.copyAllErrors(db.mErrors);
				CError tError = new CError();
				tError.moduleName = "CV_NHYDBSet";
