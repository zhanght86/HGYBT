...
public class ContDBSet extends ContSet
{
	// @Field
	...
	**/
	...
	// @Constructor
	public ContDBSet(Connection tConnection)
	{
		con = tConnection;
	...
	public boolean insert()
	{
		...
		for (int i = 1; i <= n; i++)
		{
			...
			aSchema.setSchema( (ContSchema)this.get(i) );
			if (db.insert(aSchema) == false)
			{
				// @@错误处理
				this.mErrors.copyAllErrors(db.mErrors);
				CError tError = new CError();
				tError.moduleName = "ContDBSet";
