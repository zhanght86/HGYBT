...
import com.sinosoft.lis.db.PA_NHYDB;

public class PA_NHYSchema implements Schema
{
	// @Field
	/** 产品代码 */
	...
	/**
	* 使用另外一个 PA_NHYSchema 对象给 Schema 赋值
	* @param: Schema 对象
	* @return: 无
	**/
	public void setSchema(PA_NHYSchema aPA_NHYSchema)
	{
		this.RiskCode = aPA_NHYSchema.getRiskCode();
		this.AXARiskCode = aPA_NHYSchema.getAXARiskCode();
		this.InsuredAge = aPA_NHYSchema.getInsuredAge();
		this.InsuredSex = aPA_NHYSchema.getInsuredSex();
		this.PayIntv = aPA_NHYSchema.getPayIntv();
		this.PayEndYearFlag = aPA_NHYSchema.getPayEndYearFlag();
		this.PayEndYear = aPA_NHYSchema.getPayEndYear();
		this.PremRate = aPA_NHYSchema.getPremRate();
		this.SmokeFlag = aPA_NHYSchema.getSmokeFlag();
		this.PremScale = aPA_NHYSchema.getPremScale();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		catch(SQLException sqle)
		{
			...
			tError.moduleName = "PA_NHYSchema";
	...
	public PA_NHYSchema getSchema()
	{
		PA_NHYSchema aPA_NHYSchema = new PA_NHYSchema();
		aPA_NHYSchema.setSchema(this);
		return aPA_NHYSchema;
	}

	public PA_NHYDB getDB()
	{
		PA_NHYDB aDBOper = new PA_NHYDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpPA_NHY描述/A>表字段
	* @param: 无
	* @return: 返回打包后字符串
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpPA_NHY>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			PremRate = new Double(ChgData.chgNumericStr(StrTool.getStr(strMessage,8,SysConst.PACKAGESPILTER))).doubleValue();
			SmokeFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		PA_NHYSchema other = (PA_NHYSchema)otherObject;
		return
