/*
 * <p>ClassName: FundPriceUpSchema </p>
...
import com.sinosoft.lis.db.FundPriceUpDB;

public class FundPriceUpSchema implements Schema
{
	// @Field
	/** 主键 */
	private int Oid;
	...
	/**
	* 使用另外一个 FundPriceUpSchema 对象给 Schema 赋值
	* @param: Schema 对象
	* @return: 无
	**/
	public void setSchema(FundPriceUpSchema aFundPriceUpSchema)
	{
		this.Oid = aFundPriceUpSchema.getOid();
		this.FundCode = aFundPriceUpSchema.getFundCode();
		this.PriceEffectiveDate = aFundPriceUpSchema.getPriceEffectiveDate();
		this.Currency = aFundPriceUpSchema.getCurrency();
		this.UtilPrice = aFundPriceUpSchema.getUtilPrice();
		this.OfferPrice = aFundPriceUpSchema.getOfferPrice();
		this.BidPrice = aFundPriceUpSchema.getBidPrice();
		this.HadProcessed = aFundPriceUpSchema.getHadProcessed();
		this.MakeDate = aFundPriceUpSchema.getMakeDate();
		this.ModifyDate = aFundPriceUpSchema.getModifyDate();
		this.ExtractedDate = aFundPriceUpSchema.getExtractedDate();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		catch(SQLException sqle)
		{
			...
			tError.moduleName = "FundPriceUpSchema";
	...
	public FundPriceUpSchema getSchema()
	{
		FundPriceUpSchema aFundPriceUpSchema = new FundPriceUpSchema();
		aFundPriceUpSchema.setSchema(this);
		return aFundPriceUpSchema;
	}

	public FundPriceUpDB getDB()
	{
		FundPriceUpDB aDBOper = new FundPriceUpDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpFundPriceUp描述/A>表字段
	* @param: 无
	* @return: 返回打包后字符串
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpFundPriceUp>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		FundPriceUpSchema other = (FundPriceUpSchema)otherObject;
		return
			Oid == other.getOid()
