...
public class LMCheckFieldSchema implements Schema
{
	...
	**/
	public void setSchema(LMCheckFieldSchema aLMCheckFieldSchema)
	{
		...
		this.Remark = aLMCheckFieldSchema.getRemark();
		this.Remark2 = aLMCheckFieldSchema.getRemark2();
		this.SequenceNo = aLMCheckFieldSchema.getSequenceNo();
		this.bak1 = aLMCheckFieldSchema.getbak1();
		this.bak2 = aLMCheckFieldSchema.getbak2();
		this.bak3 = aLMCheckFieldSchema.getbak3();
		this.bak4 = aLMCheckFieldSchema.getbak4();
		this.UWFlag = aLMCheckFieldSchema.getUWFlag();
		this.UWCode = aLMCheckFieldSchema.getUWCode();
	}
