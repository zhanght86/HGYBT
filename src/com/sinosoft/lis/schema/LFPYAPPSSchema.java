...
import com.sinosoft.lis.db.LFPYAPPSDB;

public class LFPYAPPSSchema implements Schema
{
	// @Field
	/** 流水号 */
...
缴费类型 */
	...
	/**
	* 使用另外一个 LFPYAPPSSchema 对象给 Schema 赋值
	* @param: Schema 对象
	* @return: 无
	**/
	public void setSchema(LFPYAPPSSchema aLFPYAPPSSchema)
	{
		this.SerialNo = aLFPYAPPSSchema.getSerialNo();
		this.YNO = aLFPYAPPSSchema.getYNO();
		this.YSTUA = aLFPYAPPSSchema.getYSTUA();
		this.YMPREM = aLFPYAPPSSchema.getYMPREM();
		this.YMPREM1 = aLFPYAPPSSchema.getYMPREM1();
		this.YMPREM2 = aLFPYAPPSSchema.getYMPREM2();
		this.YMPREM3 = aLFPYAPPSSchema.getYMPREM3();
		this.YNAME = aLFPYAPPSSchema.getYNAME();
		this.YID = aLFPYAPPSSchema.getYID();
		this.YOWNER = aLFPYAPPSSchema.getYOWNER();
		this.YPLAN = aLFPYAPPSSchema.getYPLAN();
		this.YSA = aLFPYAPPSSchema.getYSA();
		this.YMODE = aLFPYAPPSSchema.getYMODE();
		this.YLPRE = aLFPYAPPSSchema.getYLPRE();
		this.YLPREA = aLFPYAPPSSchema.getYLPREA();
		this.YMDAT = fDate.getDate( aLFPYAPPSSchema.getYMDAT());
		this.YFLAG = aLFPYAPPSSchema.getYFLAG();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		catch(SQLException sqle)
		{
			...
			tError.moduleName = "LFPYAPPSSchema";
	...
	public LFPYAPPSSchema getSchema()
	{
		LFPYAPPSSchema aLFPYAPPSSchema = new LFPYAPPSSchema();
		aLFPYAPPSSchema.setSchema(this);
		return aLFPYAPPSSchema;
	}

	public LFPYAPPSDB getDB()
	{
		LFPYAPPSDB aDBOper = new LFPYAPPSDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLFPYAPPS描述/A>表字段
	* @param: 无
	* @return: 返回打包后字符串
	**/
	public String encode()
	{
		...
		strReturn = StrTool.cTrim( StrTool.unicodeToGBK(SerialNo) ) + SysConst.PACKAGESPILTER
					...
					+ StrTool.cTrim( StrTool.unicodeToGBK(YFLAG) );
		return strReturn;
	}

	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLFPYAPPS>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LFPYAPPSSchema other = (LFPYAPPSSchema)otherObject;
		return
