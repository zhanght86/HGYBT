...
public class LBInsureAccSchema implements Schema
{
	// @Field
	/** 保险帐户号码 */
	...
	**/
	public void setSchema(LBInsureAccSchema aLBInsureAccSchema)
	{
		...
		this.AccCode = aLBInsureAccSchema.getAccCode();
		this.AccName = aLBInsureAccSchema.getAccName();
		this.AccRate = aLBInsureAccSchema.getAccRate();
		this.AccTimeFlag = aLBInsureAccSchema.getAccTimeFlag();
