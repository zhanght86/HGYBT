...
import com.sinosoft.lis.db.LBAddressDB;

public class LBAddressSchema implements Schema
{
	// @Field
	/** 客户号码 */
	...
	/**
	* 使用另外一个 LBAddressSchema 对象给 Schema 赋值
	* @param: Schema 对象
	* @return: 无
	**/
	public void setSchema(LBAddressSchema aLBAddressSchema)
	{
		this.CustomerNo = aLBAddressSchema.getCustomerNo();
		this.AddressNo = aLBAddressSchema.getAddressNo();
		this.PostalAddress = aLBAddressSchema.getPostalAddress();
		this.ZipCode = aLBAddressSchema.getZipCode();
		this.Phone = aLBAddressSchema.getPhone();
		this.Fax = aLBAddressSchema.getFax();
		this.HomeAddress = aLBAddressSchema.getHomeAddress();
		this.HomeZipCode = aLBAddressSchema.getHomeZipCode();
		this.HomePhone = aLBAddressSchema.getHomePhone();
		this.HomeFax = aLBAddressSchema.getHomeFax();
		this.CompanyAddress = aLBAddressSchema.getCompanyAddress();
		this.CompanyZipCode = aLBAddressSchema.getCompanyZipCode();
		this.CompanyPhone = aLBAddressSchema.getCompanyPhone();
		this.CompanyFax = aLBAddressSchema.getCompanyFax();
		this.Mobile = aLBAddressSchema.getMobile();
		this.MobileChs = aLBAddressSchema.getMobileChs();
		this.EMail = aLBAddressSchema.getEMail();
		this.BP = aLBAddressSchema.getBP();
		this.Mobile2 = aLBAddressSchema.getMobile2();
		this.MobileChs2 = aLBAddressSchema.getMobileChs2();
		this.EMail2 = aLBAddressSchema.getEMail2();
		this.BP2 = aLBAddressSchema.getBP2();
		this.Operator = aLBAddressSchema.getOperator();
		this.MakeDate = fDate.getDate( aLBAddressSchema.getMakeDate());
		this.MakeTime = aLBAddressSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLBAddressSchema.getModifyDate());
		this.ModifyTime = aLBAddressSchema.getModifyTime();
		this.GrpName = aLBAddressSchema.getGrpName();
		this.Province = aLBAddressSchema.getProvince();
		this.City = aLBAddressSchema.getCity();
		this.County = aLBAddressSchema.getCounty();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		catch(SQLException sqle)
		{
			...
			tError.moduleName = "LBAddressSchema";
	...
	public LBAddressSchema getSchema()
	{
		LBAddressSchema aLBAddressSchema = new LBAddressSchema();
		aLBAddressSchema.setSchema(this);
		return aLBAddressSchema;
	}

	public LBAddressDB getDB()
	{
		LBAddressDB aDBOper = new LBAddressDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLBAddress>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LBAddressSchema other = (LBAddressSchema)otherObject;
		return
