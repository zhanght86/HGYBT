/*
 * <p>ClassName: AxaMissingInfoSchema </p>
...
import com.sinosoft.lis.db.AxaMissingInfoDB;

public class AxaMissingInfoSchema implements Schema
{
	// @Field
	/** 主键 */
	private int Oid;
	...
	/**
	* 使用另外一个 AxaMissingInfoSchema 对象给 Schema 赋值
	* @param: Schema 对象
	* @return: 无
	**/
	public void setSchema(AxaMissingInfoSchema aAxaMissingInfoSchema)
	{
		this.Oid = aAxaMissingInfoSchema.getOid();
		this.ExtractedDate = aAxaMissingInfoSchema.getExtractedDate();
		this.PolicyNo = aAxaMissingInfoSchema.getPolicyNo();
		this.ApplicationNo = aAxaMissingInfoSchema.getApplicationNo();
		this.InsuredIdType = aAxaMissingInfoSchema.getInsuredIdType();
		this.ApplicantIdType = aAxaMissingInfoSchema.getApplicantIdType();
		this.ApplicantIdNo = aAxaMissingInfoSchema.getApplicantIdNo();
		this.ApplicantAcctNo = aAxaMissingInfoSchema.getApplicantAcctNo();
		this.CustomerNo = aAxaMissingInfoSchema.getCustomerNo();
		this.PolicyCancelCode = aAxaMissingInfoSchema.getPolicyCancelCode();
		this.CancelReason = aAxaMissingInfoSchema.getCancelReason();
		this.HadProcessed = aAxaMissingInfoSchema.getHadProcessed();
		this.BeCovered = aAxaMissingInfoSchema.getBeCovered();
		this.MakeDate = aAxaMissingInfoSchema.getMakeDate();
		this.MakeTime = aAxaMissingInfoSchema.getMakeTime();
		this.ModifyDate = aAxaMissingInfoSchema.getModifyDate();
		this.ModifyTime = aAxaMissingInfoSchema.getModifyTime();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		catch(SQLException sqle)
		{
			...
			tError.moduleName = "AxaMissingInfoSchema";
	...
	public AxaMissingInfoSchema getSchema()
	{
		AxaMissingInfoSchema aAxaMissingInfoSchema = new AxaMissingInfoSchema();
		aAxaMissingInfoSchema.setSchema(this);
		return aAxaMissingInfoSchema;
	}

	public AxaMissingInfoDB getDB()
	{
		AxaMissingInfoDB aDBOper = new AxaMissingInfoDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpAxaMissingInfo描述/A>表字段
	* @param: 无
	* @return: 返回打包后字符串
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpAxaMissingInfo>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			ModifyDate= new Integer(ChgData.chgNumericStr(StrTool.getStr(strMessage,16,SysConst.PACKAGESPILTER))).intValue();
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		AxaMissingInfoSchema other = (AxaMissingInfoSchema)otherObject;
		return
			Oid == other.getOid()
