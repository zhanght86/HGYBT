/*
 * <p>ClassName: LKNoRealBlcDtlSchema </p>
...
import com.sinosoft.lis.db.LKNoRealBlcDtlDB;

public class LKNoRealBlcDtlSchema implements Schema
{
	// @Field
	/** 对账批次号 */
	...
	/**
	* 使用另外一个 LKNoRealBlcDtlSchema 对象给 Schema 赋值
	* @param: Schema 对象
	* @return: 无
	**/
	public void setSchema(LKNoRealBlcDtlSchema aLKNoRealBlcDtlSchema)
	{
		this.BlcTranNo = aLKNoRealBlcDtlSchema.getBlcTranNo();
		this.Type = aLKNoRealBlcDtlSchema.getType();
		this.ProposalPrtNo = aLKNoRealBlcDtlSchema.getProposalPrtNo();
		this.ContNo = aLKNoRealBlcDtlSchema.getContNo();
		this.TranDate = fDate.getDate( aLKNoRealBlcDtlSchema.getTranDate());
		this.Prem = aLKNoRealBlcDtlSchema.getPrem();
		this.TranCom = aLKNoRealBlcDtlSchema.getTranCom();
		this.TranNo = aLKNoRealBlcDtlSchema.getTranNo();
		this.ZoneNo = aLKNoRealBlcDtlSchema.getZoneNo();
		this.NodeNo = aLKNoRealBlcDtlSchema.getNodeNo();
		this.AgentCom = aLKNoRealBlcDtlSchema.getAgentCom();
		this.AgentCode = aLKNoRealBlcDtlSchema.getAgentCode();
		this.ManageCom = aLKNoRealBlcDtlSchema.getManageCom();
		this.AppntIDType = aLKNoRealBlcDtlSchema.getAppntIDType();
		this.AppntIDNo = aLKNoRealBlcDtlSchema.getAppntIDNo();
		this.AccNo = aLKNoRealBlcDtlSchema.getAccNo();
		this.AppntName = aLKNoRealBlcDtlSchema.getAppntName();
		this.InsuredName = aLKNoRealBlcDtlSchema.getInsuredName();
		this.AppFlag = aLKNoRealBlcDtlSchema.getAppFlag();
		this.SaleChannel = aLKNoRealBlcDtlSchema.getSaleChannel();
		this.RCode = aLKNoRealBlcDtlSchema.getRCode();
		this.RText = aLKNoRealBlcDtlSchema.getRText();
		this.State = aLKNoRealBlcDtlSchema.getState();
		this.Result = aLKNoRealBlcDtlSchema.getResult();
		this.Bak1 = aLKNoRealBlcDtlSchema.getBak1();
		this.Bak2 = aLKNoRealBlcDtlSchema.getBak2();
		this.Bak3 = aLKNoRealBlcDtlSchema.getBak3();
		this.Bak4 = aLKNoRealBlcDtlSchema.getBak4();
		this.Bak5 = aLKNoRealBlcDtlSchema.getBak5();
		this.MakeDate = fDate.getDate( aLKNoRealBlcDtlSchema.getMakeDate());
		this.MakeTime = aLKNoRealBlcDtlSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLKNoRealBlcDtlSchema.getModifyDate());
		this.ModifyTime = aLKNoRealBlcDtlSchema.getModifyTime();
		this.Operator = aLKNoRealBlcDtlSchema.getOperator();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		catch(SQLException sqle)
		{
			...
			tError.moduleName = "LKNoRealBlcDtlSchema";
	...
	public LKNoRealBlcDtlSchema getSchema()
	{
		LKNoRealBlcDtlSchema aLKNoRealBlcDtlSchema = new LKNoRealBlcDtlSchema();
		aLKNoRealBlcDtlSchema.setSchema(this);
		return aLKNoRealBlcDtlSchema;
	}

	public LKNoRealBlcDtlDB getDB()
	{
		LKNoRealBlcDtlDB aDBOper = new LKNoRealBlcDtlDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLKNoRealBlcDtl描述/A>表字段
	* @param: 无
	* @return: 返回打包后字符串
	**/
	public String encode()
	{
		...
		strReturn =  ChgData.chgData(BlcTranNo) + SysConst.PACKAGESPILTER
					...
					+ StrTool.cTrim( StrTool.unicodeToGBK(AccNo) ) + SysConst.PACKAGESPILTER
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLKNoRealBlcDtl>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			AccNo = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 16, SysConst.PACKAGESPILTER );
			...
			AppFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 19, SysConst.PACKAGESPILTER );
			SaleChannel = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 20, SysConst.PACKAGESPILTER );
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LKNoRealBlcDtlSchema other = (LKNoRealBlcDtlSchema)otherObject;
		return
