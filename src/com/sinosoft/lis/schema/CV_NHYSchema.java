...
import com.sinosoft.lis.db.CV_NHYDB;

public class CV_NHYSchema implements Schema
{
	// @Field
	/** 产品代码 */
	...
	/**
	* 使用另外一个 CV_NHYSchema 对象给 Schema 赋值
	* @param: Schema 对象
	* @return: 无
	**/
	public void setSchema(CV_NHYSchema aCV_NHYSchema)
	{
		this.RiskCode = aCV_NHYSchema.getRiskCode();
		this.AXARiskCode = aCV_NHYSchema.getAXARiskCode();
		this.InsuredAge = aCV_NHYSchema.getInsuredAge();
		this.InsuredSex = aCV_NHYSchema.getInsuredSex();
		this.PayIntv = aCV_NHYSchema.getPayIntv();
		this.PayEndYearFlag = aCV_NHYSchema.getPayEndYearFlag();
		this.PayEndYear = aCV_NHYSchema.getPayEndYear();
		this.PolicyYear = aCV_NHYSchema.getPolicyYear();
		this.PremRate = aCV_NHYSchema.getPremRate();
		this.PremScale = aCV_NHYSchema.getPremScale();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		catch(SQLException sqle)
		{
			...
			tError.moduleName = "CV_NHYSchema";
	...
	public CV_NHYSchema getSchema()
	{
		CV_NHYSchema aCV_NHYSchema = new CV_NHYSchema();
		aCV_NHYSchema.setSchema(this);
		return aCV_NHYSchema;
	}

	public CV_NHYDB getDB()
	{
		CV_NHYDB aDBOper = new CV_NHYDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpCV_NHY>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		CV_NHYSchema other = (CV_NHYSchema)otherObject;
		return
