...
public class LCBnfSchema implements Schema
{
	// @Field
	/** 合同号码 */
	...
	/**
	* 使用另外一个 LCBnfSchema 对象给 Schema 赋值
	* @param: Schema 对象
	* @return: 无
	**/
	public void setSchema(LCBnfSchema aLCBnfSchema)
	{
		this.ContNo = aLCBnfSchema.getContNo();
		this.PolNo = aLCBnfSchema.getPolNo();
		this.InsuredNo = aLCBnfSchema.getInsuredNo();
		this.BnfType = aLCBnfSchema.getBnfType();
		this.BnfNo = aLCBnfSchema.getBnfNo();
		this.BnfGrade = aLCBnfSchema.getBnfGrade();
		this.RelationToInsured = aLCBnfSchema.getRelationToInsured();
		this.BnfLot = aLCBnfSchema.getBnfLot();
		this.CustomerNo = aLCBnfSchema.getCustomerNo();
		this.Name = aLCBnfSchema.getName();
		this.Sex = aLCBnfSchema.getSex();
		this.Birthday = fDate.getDate( aLCBnfSchema.getBirthday());
		this.IDType = aLCBnfSchema.getIDType();
		this.IDNo = aLCBnfSchema.getIDNo();
		this.Operator = aLCBnfSchema.getOperator();
		this.MakeDate = fDate.getDate( aLCBnfSchema.getMakeDate());
		this.MakeTime = aLCBnfSchema.getMakeTime();
		this.ModifyDate = fDate.getDate( aLCBnfSchema.getModifyDate());
		this.ModifyTime = aLCBnfSchema.getModifyTime();
	}
	...
	**/
	...
	public LCBnfSchema getSchema()
	{
		LCBnfSchema aLCBnfSchema = new LCBnfSchema();
		aLCBnfSchema.setSchema(this);
		return aLCBnfSchema;
	}

	public LCBnfDB getDB()
	{
		LCBnfDB aDBOper = new LCBnfDB();
	...
	/**
	* 数据打包，按 XML 格式打包，顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCBnf描述/A>表字段
	* @param: 无
	* @return: 返回打包后字符串
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLCBnf>历史记账凭证主表信息</A>表字段
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LCBnfSchema other = (LCBnfSchema)otherObject;
		return
