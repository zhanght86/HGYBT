/*
 * <p>ClassName: LMPublicCheckFieldSchema </p>
...
import com.sinosoft.lis.db.LMPublicCheckFieldDB;

public class LMPublicCheckFieldSchema implements Schema
{
	// @Field
	/** 算法编码 */
	...
	// @Constructor
	public LMPublicCheckFieldSchema()
	{
		mErrors = new CErrors();
	...
	/**
	* 使用另外一个 LMPublicCheckFieldSchema 对象给 Schema 赋值
	* @param: Schema 对象
	* @return: 无
	**/
	public void setSchema(LMPublicCheckFieldSchema aLMPublicCheckFieldSchema)
	{
		this.CalCode = aLMPublicCheckFieldSchema.getCalCode();
		this.RiskCode = aLMPublicCheckFieldSchema.getRiskCode();
		this.Remark = aLMPublicCheckFieldSchema.getRemark();
		this.Remark2 = aLMPublicCheckFieldSchema.getRemark2();
		this.SequenceNo = aLMPublicCheckFieldSchema.getSequenceNo();
		this.bak1 = aLMPublicCheckFieldSchema.getbak1();
		this.bak2 = aLMPublicCheckFieldSchema.getbak2();
		this.bak3 = aLMPublicCheckFieldSchema.getbak3();
		this.bak4 = aLMPublicCheckFieldSchema.getbak4();
		this.UWFlag = aLMPublicCheckFieldSchema.getUWFlag();
		this.UWCode = aLMPublicCheckFieldSchema.getUWCode();
	}
	...
	**/
	public boolean setSchema(ResultSet rs,int i)
	{
		...
		catch(SQLException sqle)
		{
			...
			tError.moduleName = "LMPublicCheckFieldSchema";
	...
	public LMPublicCheckFieldSchema getSchema()
	{
		LMPublicCheckFieldSchema aLMPublicCheckFieldSchema = new LMPublicCheckFieldSchema();
		aLMPublicCheckFieldSchema.setSchema(this);
		return aLMPublicCheckFieldSchema;
	}

	public LMPublicCheckFieldDB getDB()
	{
		LMPublicCheckFieldDB aDBOper = new LMPublicCheckFieldDB();
	...
	**/
	...
	/**
	* 数据解包，解包顺序参见<A href ={@docRoot}/dataStructure/tb.html#PrpLMPublicCheckField>历史记账凭证主表信息</A>表字段
	...
	**/
	public boolean decode(String strMessage)
	{
		try
		{
			...
			bak3 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 8, SysConst.PACKAGESPILTER );
			bak4 = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 9, SysConst.PACKAGESPILTER );
			UWFlag = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 10, SysConst.PACKAGESPILTER );
			UWCode = StrTool.getStr(StrTool.GBKToUnicode(strMessage), 11, SysConst.PACKAGESPILTER );
		}
	...
	**/
	...
	public boolean equals(Object otherObject)
	{
		...
		LMPublicCheckFieldSchema other = (LMPublicCheckFieldSchema)otherObject;
		return
