/*
 * <p>ClassName: LMUWDB </p>
 * <p>Description: DB灞傛暟鎹簱鎿嶄綔绫绘枃浠�</p>
 * <p>Copyright: Copyright (c) 2002</p>
 * <p>Company: sinosoft </p>
 * @Database: 閲戠洓
 * @CreateDate锛�011-12-27
 */
...
public class LMUWDB extends LMUWSchema
{
	// @Field
	...
	**/
	...
	// @Constructor
	public LMUWDB( Connection tConnection )
	{
		con = tConnection;
	...
	{
		LMUWSchema tSchema = this.getSchema();
		if (!db.insert(tSchema))
		{
			// @@閿欒澶勭悊
			this.mErrors.copyAllErrors(db.mErrors);
			CError tError = new CError();
			tError.moduleName = "LMUWDB";
	...
	public boolean getInfo()
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			LMUWSchema aSchema = this.getSchema();
	...
	public LMUWSet query()
	{
		Statement stmt = null;
		ResultSet rs = null;
		LMUWSet aLMUWSet = new LMUWSet();
	...
	public LMUWSet executeQuery(String sql)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LMUWSet aLMUWSet = new LMUWSet();
	...
	public LMUWSet query(int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LMUWSet aLMUWSet = new LMUWSet();
	...
	public LMUWSet executeQuery(String sql, int nStart, int nCount)
	{
		Statement stmt = null;
		ResultSet rs = null;
		LMUWSet aLMUWSet = new LMUWSet();
	...
	public boolean update(String strWherePart)
	{
	  ...
	  if( !mflag ) {
		...
		try
		{
			...
			String sql = "update LMUW " + sqlObj.getUpdPart() + " where " + strWherePart;
