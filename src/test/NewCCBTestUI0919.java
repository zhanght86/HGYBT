...
public class NewCCBTestUI0919 {
	...
	public static void main(String[] args) throws Exception {
		...
		String mInFilePath = "F:/toubao.xml";
		
		
		String mOutFilePath = "F:/toubao_out.xml";

			NewCCBTestUI0919 mTestUI = new NewCCBTestUI0919(mIP,	mPort);
...
//			JdomUtil.output(mOutXmlDoc, mFos);
	...
	public NewCCBTestUI0919(String pIP, int pPort) {
		cIP = pIP;
		cPort = pPort;
	}
