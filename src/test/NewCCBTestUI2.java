...
//		String mOutFilePath = "D:/task/20161206/newccb/P53818152out_noStd.xml";
		...
		//[D:/task/20161216/newccb/core_local/10452_551_1012_in.xml]
		String mInFilePath = "D:/task/20161216/newccb/core_local/10452_551_1012_in.xml";//输入文件路径
		//[D:/task/20161216/newccb/local/1012/P53819113in_noStd.xml]
		mInFilePath="D:/task/20161216/newccb/local/1012/P53819113in_noStd.xml";
		//[D:/task/20161216/newccb/core_local/10452_551_1012_out.xml]
		String mOutFilePath = "D:/task/20161216/newccb/core_local/10452_551_1012_out.xml";//输出文件路径
		//D:/task/20161216/newccb/local/1012/P53819113out_noStd.xml
		mOutFilePath="D:/task/20161216/newccb/local/1012/P53819113out_noStd.xml";
//		
		//新单确认
...
//		String mInFilePath = "D:/task/20161215/P53818154in_noStd.xml";
//		String mOutFilePath = "D:/task/20161215/P53818154out_noStd.xml";
...
//		String mOutFilePath = "F:\\xml\\CCB\\P538191F1_驻点_out.xml";
			...
			NewCCBTestUI2 mTestUI = new NewCCBTestUI2(mIP,mPort);
			//通过输入文件路径创建文件输入流
			//[File:/task/20161216/newccb/local/1012/P53819113in_noStd.xml]
	 ...
	 * @param pPort 端口号
	 */
	public NewCCBTestUI2(String pIP, int pPort) {
...
//		return mCCBCipher.decode(mOutCipherBodyBytes);  //解密
	...
	public byte[] sendRequest(String pFuncFlag, Document document) throws Exception {
		...
		byte[] mInTotalBytes = new byte[mInClearBodyBytes.length + 6];//输入总字节数组
